 ...
 */function defineInjectable(opts){return{providedIn:opts.providedIn||null,factory:opts.factory}}function defineInjector(options){return{factory:options.factory,providers:options.providers||[],imports:options.imports||[]}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function makeDecorator(name,props,parentClass,chainFn,typeFn){var metaCtor=makeMetadataCtor(props);function DecoratorFactory(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];if(this instanceof DecoratorFactory)return metaCtor.call.apply(metaCtor,[this].concat(args)),this;var _a,annotationInstance=new((_a=DecoratorFactory).bind.apply(_a,[void 0].concat(args))),TypeDecorator=function(cls){return typeFn&&typeFn.apply(void 0,[cls].concat(args)),(cls.hasOwnProperty(ANNOTATIONS)?cls[ANNOTATIONS]:Object.defineProperty(cls,ANNOTATIONS,{value:[]})[ANNOTATIONS]).push(annotationInstance),cls};return chainFn&&chainFn(TypeDecorator),TypeDecorator}return parentClass&&(DecoratorFactory.prototype=Object.create(parentClass.prototype)),DecoratorFactory.prototype.ngMetadataName=name,DecoratorFactory.annotationCls=DecoratorFactory,DecoratorFactory}function makeMetadataCtor(props){return function(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];if(props){var values=props.apply(void 0,args);for(var propName in values)this[propName]=values[propName]}}}function makeParamDecorator(name,props,parentClass){var metaCtor=makeMetadataCtor(props);function ParamDecoratorFactory(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];if(this instanceof ParamDecoratorFactory)return metaCtor.apply(this,args),this;var _a,annotationInstance=new((_a=ParamDecoratorFactory).bind.apply(_a,[void 0].concat(args)));return ParamDecorator.annotation=annotationInstance,ParamDecorator;function ParamDecorator(cls,unusedKey,index){for(var parameters=cls.hasOwnProperty(PARAMETERS)?cls[PARAMETERS]:Object.defineProperty(cls,PARAMETERS,{value:[]})[PARAMETERS];parameters.length<=index;)parameters.push(null);return(parameters[index]=parameters[index]||[]).push(annotationInstance),cls}}return parentClass&&(ParamDecoratorFactory.prototype=Object.create(parentClass.prototype)),ParamDecoratorFactory.prototype.ngMetadataName=name,ParamDecoratorFactory.annotationCls=ParamDecoratorFactory,ParamDecoratorFactory}function makePropDecorator(name,props,parentClass){var metaCtor=makeMetadataCtor(props);function PropDecoratorFactory(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];if(this instanceof PropDecoratorFactory)return metaCtor.apply(this,args),this;var _a,decoratorInstance=new((_a=PropDecoratorFactory).bind.apply(_a,[void 0].concat(args)));return function(target,name){var constructor=target.constructor,meta=constructor.hasOwnProperty(PROP_METADATA)?constructor[PROP_METADATA]:Object.defineProperty(constructor,PROP_METADATA,{value:{}})[PROP_METADATA];meta[name]=meta.hasOwnProperty(name)&&meta[name]||[],meta[name].unshift(decoratorInstance)}}return parentClass&&(PropDecoratorFactory.prototype=Object.create(parentClass.prototype)),PropDecoratorFactory.prototype.ngMetadataName=name,PropDecoratorFactory.annotationCls=PropDecoratorFactory,PropDecoratorFactory}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function forwardRef(forwardRefFn){return forwardRefFn.__forward_ref__=forwardRef,forwardRefFn.toString=function(){return stringify(this())},forwardRefFn}function resolveForwardRef(type){return"function"==typeof type&&type.hasOwnProperty("__forward_ref__")&&type.__forward_ref__===forwardRef?type():type}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var Inject=makeParamDecorator("Inject",function(token){return{token:token}}),Optional=makeParamDecorator("Optional"),Self=makeParamDecorator("Self"),SkipSelf=makeParamDecorator("SkipSelf"),Host=makeParamDecorator("Host"),SOURCE="__source",_THROW_IF_NOT_FOUND=new Object,THROW_IF_NOT_FOUND=_THROW_IF_NOT_FOUND,INJECTOR=new InjectionToken("INJECTOR"),NullInjector=function(){function NullInjector(){}return NullInjector.prototype.get=function(token,notFoundValue){if(void 0===notFoundValue&&(notFoundValue=_THROW_IF_NOT_FOUND),notFoundValue===_THROW_IF_NOT_FOUND)throw new Error("NullInjectorError: No provider for "+stringify(token)+"!");return notFoundValue},NullInjector}(),Injector=function(){function Injector(){}return Injector.create=function(options,parent){return Array.isArray(options)?new StaticInjector(options,parent):new StaticInjector(options.providers,options.parent,options.name||null)},Injector.THROW_IF_NOT_FOUND=_THROW_IF_NOT_FOUND,Injector.NULL=new NullInjector,Injector.ngInjectableDef=defineInjectable({providedIn:"any",factory:function(){return inject(INJECTOR)}}),Injector}(),IDENT=function(value){return value},EMPTY=[],CIRCULAR=IDENT,MULTI_PROVIDER_FN=function(){return Array.prototype.slice.call(arguments)},GET_PROPERTY_NAME$1={},USE_VALUE$1=function(objWithPropertyToExtract){for(var key in objWithPropertyToExtract)if(objWithPropertyToExtract[key]===GET_PROPERTY_NAME$1)return key;throw Error("!prop")}({provide:String,useValue:GET_PROPERTY_NAME$1}),NG_TEMP_TOKEN_PATH="ngTempTokenPath",NULL_INJECTOR=Injector.NULL,NEW_LINE=/\n/gm,NO_NEW_LINE="ɵ",StaticInjector=function(){function StaticInjector(providers,parent,source){void 0===parent&&(parent=NULL_INJECTOR),void 0===source&&(source=null),this.parent=parent,this.source=source;var records=this._records=new Map;records.set(Injector,{token:Injector,fn:IDENT,deps:EMPTY,value:this,useNew:!1}),records.set(INJECTOR,{token:Injector,fn:IDENT,deps:EMPTY,value:this,useNew:!1}),function recursivelyProcessProviders(records,provider){if(provider)if((provider=resolveForwardRef(provider))instanceof Array)for(var i=0;i<provider.length;i++)recursivelyProcessProviders(records,provider[i]);else{if("function"==typeof provider)throw staticError("Function/Class not supported",provider);if(!provider||"object"!=typeof provider||!provider.provide)throw staticError("Unexpected provider",provider);var token=resolveForwardRef(provider.provide),resolvedProvider=function(provider){var deps=function(provider){var deps=EMPTY,providerDeps=provider.deps;if(providerDeps&&providerDeps.length){deps=[];for(var i=0;i<providerDeps.length;i++){var options=6,token=resolveForwardRef(providerDeps[i]);if(token instanceof Array)for(var j=0,annotations=token;j<annotations.length;j++){var annotation=annotations[j];annotation instanceof Optional||annotation==Optional?options|=1:annotation instanceof SkipSelf||annotation==SkipSelf?options&=-3:annotation instanceof Self||annotation==Self?options&=-5:token=annotation instanceof Inject?annotation.token:resolveForwardRef(annotation)}deps.push({token:token,options:options})}}else if(provider.useExisting){var token=resolveForwardRef(provider.useExisting);deps=[{token:token,options:6}]}else if(!(providerDeps||USE_VALUE$1 in provider))throw staticError("'deps' required",provider);return deps}(provider),fn=IDENT,value=EMPTY,useNew=!1,provide=resolveForwardRef(provider.provide);if(USE_VALUE$1 in provider)value=provider.useValue;else if(provider.useFactory)fn=provider.useFactory;else if(provider.useExisting);else if(provider.useClass)useNew=!0,fn=resolveForwardRef(provider.useClass);else{if("function"!=typeof provide)throw staticError("StaticProvider does not have [useValue|useFactory|useExisting|useClass] or [provide] is not newable",provider);useNew=!0,fn=provide}return{deps:deps,fn:fn,useNew:useNew,value:value}}(provider);if(!0===provider.multi){var multiProvider=records.get(token);if(multiProvider){if(multiProvider.fn!==MULTI_PROVIDER_FN)throw multiProviderMixError(token)}else records.set(token,multiProvider={token:provider.provide,deps:[],useNew:!1,fn:MULTI_PROVIDER_FN,value:EMPTY});token=provider,multiProvider.deps.push({token:token,options:6})}var record=records.get(token);if(record&&record.fn==MULTI_PROVIDER_FN)throw multiProviderMixError(token);records.set(token,resolvedProvider)}}(records,providers)}return StaticInjector.prototype.get=function(token,notFoundValue,flags){void 0===flags&&(flags=0);var record=this._records.get(token);try{return tryResolveToken(token,record,this._records,this.parent,notFoundValue,flags)}catch(e){var tokenPath=e[NG_TEMP_TOKEN_PATH];throw token[SOURCE]&&tokenPath.unshift(token[SOURCE]),e.message=formatError("\n"+e.message,tokenPath,this.source),e.ngTokenPath=tokenPath,e[NG_TEMP_TOKEN_PATH]=null,e}},StaticInjector.prototype.toString=function(){var tokens=[];return this._records.forEach(function(v,token){return tokens.push(stringify(token))}),"StaticInjector["+tokens.join(", ")+"]"},StaticInjector}();function multiProviderMixError(token){return staticError("Cannot mix multi providers and regular providers",token)}function tryResolveToken(token,record,records,parent,notFoundValue,flags){try{return function(token,record,records,parent,notFoundValue,flags){var value,_a;if(!record||1&flags)2&flags||(value=parent.get(token,notFoundValue,0));else{if((value=record.value)==CIRCULAR)throw Error(NO_NEW_LINE+"Circular dependency");if(value===EMPTY){record.value=CIRCULAR;var obj=void 0,useNew=record.useNew,fn=record.fn,depRecords=record.deps,deps=EMPTY;if(depRecords.length){deps=[];for(var i=0;i<depRecords.length;i++){var depRecord=depRecords[i],options=depRecord.options,childRecord=2&options?records.get(depRecord.token):void 0;deps.push(tryResolveToken(depRecord.token,childRecord,records,childRecord||4&options?parent:NULL_INJECTOR,1&options?null:Injector.THROW_IF_NOT_FOUND,0))}}record.value=value=useNew?new((_a=fn).bind.apply(_a,[void 0].concat(deps))):fn.apply(obj,deps)}}return value}(token,record,records,parent,notFoundValue,flags)}catch(e){throw e instanceof Error||(e=new Error(e)),(e[NG_TEMP_TOKEN_PATH]=e[NG_TEMP_TOKEN_PATH]||[]).unshift(token),record&&record.value==CIRCULAR&&(record.value=EMPTY),e}}function formatError(text,obj,source){void 0===source&&(source=null),text=text&&"\n"===text.charAt(0)&&text.charAt(1)==NO_NEW_LINE?text.substr(2):text;var context=stringify(obj);if(obj instanceof Array)context=obj.map(stringify).join(" -> ");else if("object"==typeof obj){var parts=[];for(var key in obj)if(obj.hasOwnProperty(key)){var value=obj[key];parts.push(key+":"+("string"==typeof value?JSON.stringify(value):stringify(value)))}context="{"+parts.join(", ")+"}"}return"StaticInjectorError"+(source?"("+source+")":"")+"["+context+"]: "+text.replace(NEW_LINE,"\n  ")}function staticError(text,obj){return new Error(formatError(text,obj))}var _currentInjector=null;function setCurrentInjector(injector){var former=_currentInjector;return _currentInjector=injector,former}function inject(token,notFoundValue,flags){if(void 0===flags&&(flags=0),null===_currentInjector)throw new Error("inject() must be called from an injection context");return _currentInjector.get(token,notFoundValue,flags)}function injectArgs(types){for(var args=[],i=0;i<types.length;i++){var arg=types[i];if(Array.isArray(arg)){if(0===arg.length)throw new Error("Arguments array must have arguments.");for(var type=void 0,defaultValue=void 0,j=0;j<arg.length;j++){var meta=arg[j];meta instanceof Optional||"Optional"===meta.__proto__.ngMetadataName?defaultValue=null:meta instanceof SkipSelf||"SkipSelf"===meta.__proto__.ngMetadataName?1:meta instanceof Self||"Self"===meta.__proto__.ngMetadataName?2:type=meta instanceof Inject?meta.token:meta}args.push(inject(type,defaultValue,0))}else args.push(inject(arg))}return args}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var GET_PROPERTY_NAME={},USE_VALUE=function(objWithPropertyToExtract,target){for(var key in objWithPropertyToExtract)if(objWithPropertyToExtract[key]===target)return key;throw Error("Could not find renamed property on target object.")}({provide:String,useValue:GET_PROPERTY_NAME},GET_PROPERTY_NAME),EMPTY_ARRAY=[];function convertInjectableProviderToFactory(type,provider){if(!provider){var deps_1=(reflectionCapabilities=new ReflectionCapabilities).parameters(type);return function(){return new(type.bind.apply(type,[void 0].concat(injectArgs(deps_1))))}}if(USE_VALUE in provider){var valueProvider_1=provider;return function(){return valueProvider_1.useValue}}if(provider.useExisting){var existingProvider_1=provider;return function(){return inject(existingProvider_1.useExisting)}}if(provider.useFactory){var factoryProvider_1=provider;return function(){return factoryProvider_1.useFactory.apply(factoryProvider_1,injectArgs(factoryProvider_1.deps||EMPTY_ARRAY))}}if(provider.useClass){var classProvider_1=provider,deps_2=provider.deps;if(!deps_2){var reflectionCapabilities=new ReflectionCapabilities;deps_2=reflectionCapabilities.parameters(type)}return function(){return new((_a=classProvider_1.useClass).bind.apply(_a,[void 0].concat(injectArgs(deps_2))));var _a}}var deps_3=provider.deps;if(!deps_3){reflectionCapabilities=new ReflectionCapabilities;deps_3=reflectionCapabilities.parameters(type)}return function(){return new(type.bind.apply(type,[void 0].concat(injectArgs(deps_3))))}}var Injectable=makeDecorator("Injectable",void 0,void 0,void 0,function(injectableType,options){options&&void 0!==options.providedIn&&(injectableType.ngInjectableDef=defineInjectable({providedIn:options.providedIn,factory:convertInjectableProviderToFactory(injectableType,options)}))}),NgModule=makeDecorator("NgModule",function(ngModule){return ngModule},void 0,void 0,function(moduleType,metadata){var imports=metadata&&metadata.imports||[];metadata&&metadata.exports&&(imports=imports.concat([metadata.exports])),moduleType.ngInjectorDef=defineInjector({factory:convertInjectableProviderToFactory(moduleType,{useClass:moduleType}),providers:metadata&&metadata.providers,imports:imports})}),ViewEncapsulation={Emulated:0,Native:1,None:2};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var Version=function(){return function(full){this.full=full,this.major=full.split(".")[0],this.minor=full.split(".")[1],this.patch=full.split(".").slice(2).join(".")}}(),VERSION=new Version("6.0.0-rc.0"),ERROR_DEBUG_CONTEXT="ngDebugContext",ERROR_ORIGINAL_ERROR="ngOriginalError",ERROR_LOGGER="ngErrorLogger";function getDebugContext(error){return error[ERROR_DEBUG_CONTEXT]}function getOriginalError(error){return error[ERROR_ORIGINAL_ERROR]}function defaultErrorLogger(console){for(var values=[],_i=1;_i<arguments.length;_i++)values[_i-1]=arguments[_i];console.error.apply(console,values)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */(this,function(b){return' "'+b.key.displayName+'" '}).join(", ")+"])"},enumerable:!0,configurable:!0}),ReflectiveInjector_.prototype.toString=function(){return this.displayName},ReflectiveInjector_.INJECTOR_KEY=ReflectiveKey.get(Injector),ReflectiveInjector_}();var APP_ROOT=new InjectionToken("The presence of this token marks an injector as being the root injector."),NOT_YET={},CIRCULAR$1={},EMPTY_ARRAY$1=[],NULL_INJECTOR$1=void 0;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function getNullInjector(){return void 0===NULL_INJECTOR$1&&(NULL_INJECTOR$1=new NullInjector),NULL_INJECTOR$1}var R3Injector=function(){function R3Injector(def,parent){var _this=this;this.parent=parent,this.records=new Map,this.injectorDefTypes=new Set,this.onDestroy=new Set,this.destroyed=!1,deepForEach([def],function(injectorDef){return _this.processInjectorType(injectorDef,new Set)}),this.records.set(INJECTOR,makeRecord(void 0,this)),this.isRootInjector=this.records.has(APP_ROOT),this.injectorDefTypes.forEach(function(defType){return _this.get(defType)})}return R3Injector.prototype.destroy=function(){this.assertNotDestroyed(),this.destroyed=!0;try{this.onDestroy.forEach(function(service){return service.ngOnDestroy()})}finally{this.records.clear(),this.onDestroy.clear(),this.injectorDefTypes.clear()}},R3Injector.prototype.get=function(token,notFoundValue,flags){void 0===notFoundValue&&(notFoundValue=THROW_IF_NOT_FOUND),void 0===flags&&(flags=0),this.assertNotDestroyed();var value,previousInjector=setCurrentInjector(this);try{if(!(1&flags)){var record=this.records.get(token);if(void 0===record){var def=("function"==typeof(value=token)||"object"==typeof value&&value instanceof InjectionToken)&&token.ngInjectableDef||void 0;void 0!==def&&this.injectableDefInScope(def)&&(record=injectableDefRecord(token),this.records.set(token,record))}if(void 0!==record)return this.hydrate(token,record)}2&flags?getNullInjector():this.parent;return this.parent.get(token,notFoundValue)}finally{setCurrentInjector(previousInjector)}},R3Injector.prototype.assertNotDestroyed=function(){if(this.destroyed)throw new Error("Injector has already been destroyed.")},R3Injector.prototype.processInjectorType=function(defOrWrappedDef,parents){var _this=this,def=(defOrWrappedDef=resolveForwardRef(defOrWrappedDef)).ngInjectorDef,ngModule=null==def&&defOrWrappedDef.ngModule||void 0,defType=void 0===ngModule?defOrWrappedDef:ngModule,providers=void 0!==ngModule&&defOrWrappedDef.providers||EMPTY_ARRAY$1;if(void 0!==ngModule&&(def=ngModule.ngInjectorDef),null==def)throw new Error("Type "+stringify(defType)+" is missing an ngInjectorDef definition.");if(parents.has(defType))throw new Error("Circular dependency: type "+stringify(defType)+" ends up importing itself.");if(this.injectorDefTypes.add(defType),this.records.set(defType,makeRecord(def.factory)),null!=def.imports){parents.add(defType);try{deepForEach(def.imports,function(imported){return _this.processInjectorType(imported,parents)})}finally{parents.delete(defType)}}null!=def.providers&&deepForEach(def.providers,function(provider){return _this.processProvider(provider)}),deepForEach(providers,function(provider){return _this.processProvider(provider)})},R3Injector.prototype.processProvider=function(provider){var token=isTypeProvider(provider=resolveForwardRef(provider))?provider:resolveForwardRef(provider.provide),record=function(provider){var token=resolveForwardRef(provider),value=NOT_YET,factory=void 0;if(isTypeProvider(provider))return injectableDefRecord(provider);if(token=resolveForwardRef(provider.provide),function(value){return USE_VALUE$1 in value}(provider))value=provider.useValue;else if(function(value){return!!value.useExisting}(provider))factory=function(){return inject(provider.useExisting)};else if(function(value){return!!value.useFactory}(provider))factory=function(){return provider.useFactory.apply(provider,injectArgs(provider.deps||[]))};else{var classRef_1=provider.useClass||token;if(!function(value){return!!value.deps}(provider))return injectableDefRecord(classRef_1);factory=function(){return new(classRef_1.bind.apply(classRef_1,[void 0].concat(injectArgs(provider.deps))))}}return makeRecord(factory,value)}(provider);if(!isTypeProvider(provider)&&!0===provider.multi){var multiRecord_1=this.records.get(token);if(multiRecord_1){if(void 0===multiRecord_1.multi)throw new Error("Mixed multi-provider for "+token+".")}else token=provider,(multiRecord_1=makeRecord(void 0,NOT_YET,!0)).factory=function(){return injectArgs(multiRecord_1.multi)},this.records.set(token,multiRecord_1);token=provider,multiRecord_1.multi.push(provider)}var existing=this.records.get(token);if(existing&&void 0!==existing.multi)throw new Error("Mixed multi-provider for "+token);this.records.set(token,record)},R3Injector.prototype.hydrate=function(token,record){if(record.value===CIRCULAR$1)throw new Error("Circular dep for "+stringify(token));var value;return record.value===NOT_YET&&(record.value=CIRCULAR$1,record.value=record.factory()),"object"==typeof record.value&&record.value&&("object"==typeof(value=record.value)&&null!=value&&value.ngOnDestroy&&"function"==typeof value.ngOnDestroy)&&this.onDestroy.add(record.value),record.value},R3Injector.prototype.injectableDefInScope=function(def){return!!def.providedIn&&("string"==typeof def.providedIn?"any"===def.providedIn||"root"===def.providedIn&&this.isRootInjector:this.injectorDefTypes.has(def.providedIn))},R3Injector}();function injectableDefRecord(token){var def=token.ngInjectableDef;if(void 0===def)throw new Error("Type "+stringify(token)+" is missing an ngInjectableDef definition.");return makeRecord(def.factory)}function makeRecord(factory,value,multi){return void 0===value&&(value=NOT_YET),void 0===multi&&(multi=!1),{factory:factory,value:value,multi:multi?[]:void 0}}function deepForEach(input,fn){input.forEach(function(value){return Array.isArray(value)?deepForEach(value,fn):fn(value)})}function isTypeProvider(value){return"function"==typeof value}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function isPromise(obj){return!!obj&&"function"==typeof obj.then}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var _platform,_testabilityGetter=new(function(){function _NoopGetTestability(){}return _NoopGetTestability.prototype.addToWindow=function(registry){},_NoopGetTestability.prototype.findTestabilityInTree=function(registry,elem,findInAncestors){return null},_NoopGetTestability}()),_devMode=!0,_runModeLocked=!1,ALLOW_MULTIPLE_PLATFORMS=new InjectionToken("AllowMultipleToken");
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var RenderComponentType=function(){return function(id,templateUrl,slotCount,encapsulation,styles,animations){this.id=id,this.templateUrl=templateUrl,this.slotCount=slotCount,this.encapsulation=encapsulation,this.styles=styles,this.animations=animations}}(),RenderDebugInfo=function(){return function(){}}(),Renderer=function(){return function(){}}(),RootRenderer=(new InjectionToken("Renderer2Interceptor"),function(){return function(){}}()),RendererFactory2=function(){return function(){}}(),RendererStyleFlags2={Important:1,DashCase:2};RendererStyleFlags2[RendererStyleFlags2.Important]="Important",RendererStyleFlags2[RendererStyleFlags2.DashCase]="DashCase";var Renderer2=function(){return function(){}}(),ElementRef=function(){return function(nativeElement){this.nativeElement=nativeElement}}(),NgModuleFactoryLoader=function(){return function(){}}(),moduleFactories=new Map;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var QueryList=function(){function QueryList(){this.dirty=!0,this._results=[],this.changes=new EventEmitter,this.length=0}return QueryList.prototype.map=function(fn){return this._results.map(fn)},QueryList.prototype.filter=function(fn){return this._results.filter(fn)},QueryList.prototype.find=function(fn){return this._results.find(fn)},QueryList.prototype.reduce=function(fn,init){return this._results.reduce(fn,init)},QueryList.prototype.forEach=function(fn){this._results.forEach(fn)},QueryList.prototype.some=function(fn){return this._results.some(fn)},QueryList.prototype.toArray=function(){return this._results.slice()},QueryList.prototype[getSymbolIterator()]=function(){return this._results[getSymbolIterator()]()},QueryList.prototype.toString=function(){return this._results.toString()},QueryList.prototype.reset=function(res){this._results=function flatten(list){return list.reduce(function(flat,item){var flatItem=Array.isArray(item)?flatten(item):item;return flat.concat(flatItem)},[])}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */()?this.getInertBodyElement=this.getInertBodyElement_DOMParser:this.getInertBodyElement=this.getInertBodyElement_InertDocument):this.getInertBodyElement=this.getInertBodyElement_XHR}return InertBodyHelper.prototype.getInertBodyElement_XHR=function(html){html="<body><remove></remove>"+html+"</body>";try{html=encodeURI(html)}catch(e){return null}var xhr=new XMLHttpRequest;xhr.responseType="document",xhr.open("GET","data:text/html;charset=utf-8,"+html,!1),xhr.send(null);var body=xhr.response.body;return body.removeChild(body.firstChild),body},InertBodyHelper.prototype.getInertBodyElement_DOMParser=function(html){html="<body><remove></remove>"+html+"</body>";try{var body=(new window.DOMParser).parseFromString(html,"text/html").body;return body.removeChild(body.firstChild),body}catch(e){return null}},InertBodyHelper.prototype.getInertBodyElement_InertDocument=function(html){var templateEl=this.inertDocument.createElement("template");return"content"in templateEl?(templateEl.innerHTML=html,templateEl):(this.inertBodyElement.innerHTML=html,this.defaultDoc.documentMode&&this.stripCustomNsAttrs(this.inertBodyElement),this.inertBodyElement)},InertBodyHelper.prototype.stripCustomNsAttrs=function(el){for(var elAttrs=el.attributes,i=elAttrs.length-1;0<i;i--){var attrName=elAttrs.item(i).name;"xmlns:ns1"!==attrName&&0!==attrName.indexOf("ns1:")||el.removeAttribute(attrName)}for(var childNode=el.firstChild;childNode;)childNode.nodeType===Node.ELEMENT_NODE&&this.stripCustomNsAttrs(childNode),childNode=childNode.nextSibling},InertBodyHelper}();
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var SAFE_URL_PATTERN=/^(?:(?:https?|mailto|ftp|tel|file):|[^&:/?#]*(?:[/?#]|$))/gi,DATA_URL_PATTERN=/^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+\/]+=*$/i;function _sanitizeUrl(url){return(url=String(url)).match(SAFE_URL_PATTERN)||url.match(DATA_URL_PATTERN)?url:(isDevMode()&&console.warn("WARNING: sanitizing unsafe URL value "+url+" (see http://g.co/ng/security#xss)"),"unsafe:"+url)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var SecurityContext={NONE:0,HTML:1,STYLE:2,SCRIPT:3,URL:4,RESOURCE_URL:5};SecurityContext[SecurityContext.NONE]="NONE",SecurityContext[SecurityContext.HTML]="HTML",SecurityContext[SecurityContext.STYLE]="STYLE",SecurityContext[SecurityContext.SCRIPT]="SCRIPT",SecurityContext[SecurityContext.URL]="URL",SecurityContext[SecurityContext.RESOURCE_URL]="RESOURCE_URL";var Sanitizer=function(){return function(){}}();
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */(33554432&def.flags&&32&binding.flags?elData.componentView:view,binding,renderNode$$1,name,value)}return!0}var UNDEFINED_VALUE=new Object,InjectorRefTokenKey$1=tokenKey(Injector),NgModuleRefTokenKey=tokenKey(NgModuleRef);function resolveNgModuleDep(data,depDef,notFoundValue){if(void 0===notFoundValue&&(notFoundValue=Injector.THROW_IF_NOT_FOUND),8&depDef.flags)return depDef.token;if(2&depDef.flags&&(notFoundValue=null),1&depDef.flags)return data._parent.get(depDef.token,notFoundValue);var tokenKey$$1=depDef.tokenKey;switch(tokenKey$$1){case InjectorRefTokenKey$1:case NgModuleRefTokenKey:return data}var ngModule,def,providerDef=data._def.providersByKey[tokenKey$$1];if(providerDef){var providerInstance=data._providers[providerDef.index];return void 0===providerInstance&&(providerInstance=data._providers[providerDef.index]=_createProviderInstance$1(data,providerDef)),providerInstance===UNDEFINED_VALUE?void 0:providerInstance}if(depDef.token.ngInjectableDef&&(ngModule=data,null!=(def=depDef.token.ngInjectableDef).providedIn&&(function(ngModule,scope){return ngModule._def.modules.indexOf(scope)>-1}(ngModule,def.providedIn)||"root"===def.providedIn&&ngModule._def.isRoot))){var injectableDef=depDef.token.ngInjectableDef,index=data._providers.length;data._def.providersByKey[depDef.tokenKey]={flags:5120,value:injectableDef.factory,deps:[],index:index,token:depDef.token};var former=setCurrentInjector(data);try{return data._providers[index]=UNDEFINED_VALUE,data._providers[index]=_createProviderInstance$1(data,data._def.providersByKey[depDef.tokenKey])}finally{setCurrentInjector(former)}}return data._parent.get(depDef.token,notFoundValue)}function _createProviderInstance$1(ngModule,providerDef){var injectable;switch(201347067&providerDef.flags){case 512:injectable=function(ngModule,ctor,deps){var len=deps.length;switch(len){case 0:return new ctor;case 1:return new ctor(resolveNgModuleDep(ngModule,deps[0]));case 2:return new ctor(resolveNgModuleDep(ngModule,deps[0]),resolveNgModuleDep(ngModule,deps[1]));case 3:return new ctor(resolveNgModuleDep(ngModule,deps[0]),resolveNgModuleDep(ngModule,deps[1]),resolveNgModuleDep(ngModule,deps[2]));default:for(var depValues=new Array(len),i=0;i<len;i++)depValues[i]=resolveNgModuleDep(ngModule,deps[i]);return new(ctor.bind.apply(ctor,[void 0].concat(depValues)))}}(ngModule,providerDef.value,providerDef.deps);break;case 1024:injectable=function(ngModule,factory,deps){var len=deps.length;switch(len){case 0:return factory();case 1:return factory(resolveNgModuleDep(ngModule,deps[0]));case 2:return factory(resolveNgModuleDep(ngModule,deps[0]),resolveNgModuleDep(ngModule,deps[1]));case 3:return factory(resolveNgModuleDep(ngModule,deps[0]),resolveNgModuleDep(ngModule,deps[1]),resolveNgModuleDep(ngModule,deps[2]));default:for(var depValues=Array(len),i=0;i<len;i++)depValues[i]=resolveNgModuleDep(ngModule,deps[i]);return factory.apply(void 0,depValues)}}(ngModule,providerDef.value,providerDef.deps);break;case 2048:injectable=resolveNgModuleDep(ngModule,providerDef.deps[0]);break;case 256:injectable=providerDef.value}return void 0===injectable?UNDEFINED_VALUE:injectable}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function assertEqual(actual,expected,msg){actual!=expected&&throwError(msg)}function assertNotEqual(actual,expected,msg){actual==expected&&throwError(msg)}function assertLessThan(actual,expected,msg){actual>=expected&&throwError(msg)}function assertNull(actual,msg){null!=actual&&throwError(msg)}function assertNotNull(actual,msg){null==actual&&throwError(msg)}function throwError(msg){throw new Error("ASSERTION ERROR: "+msg)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function queueContentHooks(def,tView,i){null!=def.afterContentInit&&(tView.contentHooks||(tView.contentHooks=[])).push(i,def.afterContentInit),null!=def.afterContentChecked&&((tView.contentHooks||(tView.contentHooks=[])).push(i,def.afterContentChecked),(tView.contentCheckHooks||(tView.contentCheckHooks=[])).push(i,def.afterContentChecked))}function queueViewHooks(def,tView,i){null!=def.afterViewInit&&(tView.viewHooks||(tView.viewHooks=[])).push(i,def.afterViewInit),null!=def.afterViewChecked&&((tView.viewHooks||(tView.viewHooks=[])).push(i,def.afterViewChecked),(tView.viewCheckHooks||(tView.viewCheckHooks=[])).push(i,def.afterViewChecked))}function queueDestroyHooks(def,tView,i){null!=def.onDestroy&&(tView.destroyHooks||(tView.destroyHooks=[])).push(i,def.onDestroy)}function executeInitHooks(currentView,tView,creationMode){1===currentView.lifecycleStage&&(executeHooks(currentView.data,tView.initHooks,tView.checkHooks,creationMode),currentView.lifecycleStage=2)}function executeHooks(data,allHooks,checkHooks,creationMode){var hooksToCall=creationMode?allHooks:checkHooks;null!=hooksToCall&&callHooks(data,hooksToCall)}function callHooks(data,arr){for(var i=0;i<arr.length;i+=2)arr[1|i].call(data[arr[i]])}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function assertNodeType(node,type){assertNotNull(node,"should be called with a node"),assertEqual(3&node.flags,type,"should be a "+typeName(type))}function assertNodeOfPossibleTypes(node){for(var types=[],_i=1;_i<arguments.length;_i++)types[_i-1]=arguments[_i];assertNotNull(node,"should be called with a node");var nodeType=3&node.flags;assertEqual(types.some(function(type){return nodeType===type}),!0,"Should be one of "+types.map(typeName).join(", "))}function typeName(type){return 1==type?"Projection":0==type?"Container":2==type?"View":3==type?"Element":"<unknown>"}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var RendererStyleFlags3={Important:1,DashCase:2};function isProceduralRenderer(renderer){return!!renderer.listen}RendererStyleFlags3[RendererStyleFlags3.Important]="Important",RendererStyleFlags3[RendererStyleFlags3.DashCase]="DashCase";var domRendererFactory3={createRenderer:function(hostElement,rendererType){return document}};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function findNextRNodeSibling(node,stopNode){for(var currentNode=node;currentNode&&currentNode!==stopNode;){var pNextOrParent=currentNode.pNextOrParent;if(pNextOrParent){for(var pNextOrParentType=3&pNextOrParent.flags;1!==pNextOrParentType;){if(nativeNode=findFirstRNode(pNextOrParent))return nativeNode;pNextOrParent=pNextOrParent.pNextOrParent}currentNode=pNextOrParent}else{for(var currentSibling=currentNode.next;currentSibling;){var nativeNode;if(nativeNode=findFirstRNode(currentSibling))return nativeNode;currentSibling=currentSibling.next}var parentNode=currentNode.parent;if(currentNode=null,parentNode){var parentType=3&parentNode.flags;0!==parentType&&2!==parentType||(currentNode=parentNode)}}}return null}function getNextLNodeWithProjection(node){var pNextOrParent=node.pNextOrParent;return pNextOrParent?1==(3&pNextOrParent.flags)?null:pNextOrParent:node.next}function getNextOrParentSiblingNode(initialNode,rootNode){for(var node=initialNode,nextNode=getNextLNodeWithProjection(node);node&&!nextNode;){if((node=node.pNextOrParent||node.parent)===rootNode)return null;nextNode=node&&getNextLNodeWithProjection(node)}return nextNode}function findFirstRNode(rootNode){for(var node=rootNode;node;){var type=3&node.flags,nextNode=null;if(3===type)return node.native;if(0===type){var childContainerData=node.data;nextNode=childContainerData.views.length?childContainerData.views[0].child:null}else nextNode=1===type?node.data.head:node.child;node=null===nextNode?getNextOrParentSiblingNode(node,rootNode):nextNode}return null}function addRemoveViewFromContainer(container,rootNode,insertMode,beforeNode){ngDevMode&&assertNodeType(container,0),ngDevMode&&assertNodeType(rootNode,2);var parentNode=container.data.renderParent,parent=parentNode?parentNode.native:null,node=rootNode.child;if(parent)for(;node;){var type=3&node.flags,nextNode=null,renderer=container.view.renderer;if(3===type)insertMode?isProceduralRenderer(renderer)?renderer.insertBefore(parent,node.native,beforeNode):parent.insertBefore(node.native,beforeNode,!0):isProceduralRenderer(renderer)?renderer.removeChild(parent,node.native):parent.removeChild(node.native),nextNode=node.next;else if(0===type){var childContainerData=node.data;childContainerData.renderParent=parentNode,nextNode=childContainerData.views.length?childContainerData.views[0].child:null}else nextNode=1===type?node.data.head:node.child;node=null===nextNode?getNextOrParentSiblingNode(node,rootNode):nextNode}}function insertView(container,newView,index){var views=container.data.views;if(index>0&&setViewNext(views[index-1],newView),index<views.length?(setViewNext(newView,views[index]),views.splice(index,0,newView)):views.push(newView),null!==container.data.renderParent){var beforeNode=findNextRNodeSibling(newView,container);if(!beforeNode){var containerNextNativeNode=container.native;void 0===containerNextNativeNode&&(containerNextNativeNode=container.native=findNextRNodeSibling(container,null)),beforeNode=containerNextNativeNode}addRemoveViewFromContainer(container,newView,!0,beforeNode)}return newView}function removeView(container,removeIndex){var views=container.data.views,viewNode=views[removeIndex];return removeIndex>0&&setViewNext(views[removeIndex-1],viewNode.next),views.splice(removeIndex,1),function(rootView){for(var viewOrContainer=rootView;viewOrContainer;){var next=null;if(viewOrContainer.views&&viewOrContainer.views.length?next=viewOrContainer.views[0].data:viewOrContainer.child?next=viewOrContainer.child:viewOrContainer.next&&(cleanUpView(viewOrContainer),next=viewOrContainer.next),null==next){for(;viewOrContainer&&!viewOrContainer.next&&viewOrContainer!==rootView;)cleanUpView(viewOrContainer),viewOrContainer=getParentState(viewOrContainer,rootView);cleanUpView(viewOrContainer||rootView),next=viewOrContainer&&viewOrContainer.next}viewOrContainer=next}}(viewNode.data),addRemoveViewFromContainer(container,viewNode,!1),container.data.queries&&container.data.queries.removeView(removeIndex),viewNode}function setViewNext(view,next){view.next=next,view.data.next=next?next.data:null}function getParentState(state,rootView){var node;return(node=state.node)&&2==(3&node.flags)?node.parent.data:state.parent===rootView?null:state.parent}function cleanUpView(view){!function(view){var cleanup=view.cleanup;if(null!=cleanup){for(var i=0;i<cleanup.length-1;i+=2)"string"==typeof cleanup[i]?(cleanup[i+1].removeEventListener(cleanup[i],cleanup[i+2],cleanup[i+3]),i+=2):cleanup[i].call(cleanup[i+1]);view.cleanup=null}}(view),function(view){var destroyHooks,tView=view.tView;null!=tView&&null!=(destroyHooks=tView.destroyHooks)&&callHooks(view.data,destroyHooks)}(view)}function canInsertNativeNode(parent,currentView){return 3==(3&parent.flags)&&(parent.view!==currentView||null===parent.data)}function appendChild(parent,child,currentView){if(null!==child&&canInsertNativeNode(parent,currentView)){var renderer=currentView.renderer;return isProceduralRenderer(renderer)?renderer.appendChild(parent.native,child):parent.native.appendChild(child),!0}return!1}function appendProjectedNode(node,currentParent,currentView){if(0!=(3&node.flags))appendChild(currentParent,node.native,currentView);else if(canInsertNativeNode(currentParent,currentView)){var lContainer=node.data;lContainer.renderParent=currentParent;for(var views=lContainer.views,i=0;i<views.length;i++)addRemoveViewFromContainer(node,views[i],!0,null)}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function isNodeMatchingSimpleSelector(tNode,selector){var noOfSelectorParts=selector.length;ngDevMode&&assertNotNull(selector[0],"the selector should have a tag name");var tagNameInSelector=selector[0];if(""!==tagNameInSelector&&tagNameInSelector!==tNode.tagName)return!1;if(1===noOfSelectorParts)return!0;if(noOfSelectorParts>1&&!tNode.attrs)return!1;for(var nodeClassAttrVal,cssClassToMatch,nodeClassesLen,matchIndex,matchEndIdx,attrsInNode=tNode.attrs,i=1;i<noOfSelectorParts;i+=2){var attrNameInSelector=selector[i],attrIdxInNode=attrsInNode.indexOf(attrNameInSelector);if(attrIdxInNode%2!=0)return!1;var attrValInSelector=selector[i+1];if(""!==attrValInSelector){var attrValInNode=attrsInNode[attrIdxInNode+1];if("class"===attrNameInSelector){for(i++;i<noOfSelectorParts;i++)if(nodeClassAttrVal=attrValInNode,cssClassToMatch=selector[i],void 0,void 0,void 0,nodeClassesLen=nodeClassAttrVal.length,matchIndex=nodeClassAttrVal.indexOf(cssClassToMatch),matchEndIdx=matchIndex+cssClassToMatch.length,-1===matchIndex||matchIndex>0&&" "!==nodeClassAttrVal[matchIndex-1]||matchEndIdx<nodeClassesLen&&" "!==nodeClassAttrVal[matchEndIdx])return!1}else if(attrValInSelector!==attrValInNode)return!1}}return!0}function isNodeMatchingSelectorWithNegations(tNode,selector){var positiveSelector=selector[0];if(null!=positiveSelector&&!isNodeMatchingSimpleSelector(tNode,positiveSelector))return!1;var negativeSelectors=selector[1];if(negativeSelectors)for(var i=0;i<negativeSelectors.length;i++)if(isNodeMatchingSimpleSelector(tNode,negativeSelectors[i]))return!1;return!0}function isNodeMatchingSelector(tNode,selector){for(var i=0;i<selector.length;i++)if(isNodeMatchingSelectorWithNegations(tNode,selector[i]))return!0;return!1}function matchingSelectorIndex(tNode,selectors,textSelectors){for(var ngProjectAsAttrVal=function(tNode){var nodeAttrs=tNode.attrs;if(null!=nodeAttrs){var ngProjectAsAttrIdx=nodeAttrs.indexOf(NG_PROJECT_AS_ATTR_NAME);if(0==(1&ngProjectAsAttrIdx))return nodeAttrs[ngProjectAsAttrIdx+1]}return null}(tNode),i=0;i<selectors.length;i++)if(ngProjectAsAttrVal===textSelectors[i]||null===ngProjectAsAttrVal&&isNodeMatchingSelector(tNode,selectors[i]))return i+1;return 0}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function isDifferent(a,b){return!(a!=a&&b!=b)&&a!==b}function stringify$1(value){return"function"==typeof value?value.name||value:"string"==typeof value?value:null==value?"":""+value}function notImplemented(){return new Error("NotImplemented")}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var renderer,rendererFactory,previousOrParentNode,isParent,tData,NG_HOST_SYMBOL="__ngHostLNode__",_CLEAN_PROMISE=Promise.resolve(null),rootDirectiveIndices=[1,0];function getPreviousOrParentNode(){return previousOrParentNode}var currentQueries,creationMode,data,bindingIndex,cleanup,currentView=null;function getCreationMode(){return creationMode}var checkNoChangesMode=!1,firstTemplatePass=!0;function enterView(newView,host){var oldView=currentView;return data=newView&&newView.data,bindingIndex=newView&&newView.bindingStartIndex||0,tData=newView&&newView.tView.data,creationMode=newView&&1==(1&newView.flags),firstTemplatePass=newView&&newView.tView.firstTemplatePass,cleanup=newView&&newView.cleanup,renderer=newView&&newView.renderer,null!=host&&(previousOrParentNode=host,isParent=!0),currentView=newView,currentQueries=newView&&newView.queries,oldView}function leaveView(newView){checkNoChangesMode||executeHooks(currentView.data,currentView.tView.viewHooks,currentView.tView.viewCheckHooks,creationMode),currentView.flags&=-6,currentView.lifecycleStage=1,enterView(newView,null)}function refreshDirectives(){executeInitAndContentHooks();var tView=currentView.tView;tView.firstTemplatePass=firstTemplatePass=!1,setHostBindings(tView.hostBindings),function(components){if(null!=components)for(var i=0;i<components.length;i++)componentRefresh(components[i]+1,components[i])}(tView.components)}function setHostBindings(bindings){if(null!=bindings)for(var i=0;i<bindings.length;i+=2){var dirIndex=bindings[i],elementIndex=bindings[1|i],def=tData[dirIndex];def.hostBindings&&def.hostBindings(dirIndex,elementIndex)}}function executeInitAndContentHooks(){if(!checkNoChangesMode){var tView=currentView.tView;executeInitHooks(currentView,tView,creationMode),executeHooks(currentView.data,tView.contentHooks,tView.contentCheckHooks,creationMode)}}function createLView(viewId,renderer,tView,template,context,flags){return{parent:currentView,id:viewId,flags:9|flags,node:null,data:[],tView:tView,cleanup:null,renderer:renderer,child:null,tail:null,next:null,bindingStartIndex:null,template:template,context:context,dynamicViewCount:0,lifecycleStage:1,queries:null}}function createLNode(index,type,native,state){var parent=isParent?previousOrParentNode:previousOrParentNode&&previousOrParentNode.parent,queries=(isParent?currentQueries:previousOrParentNode&&previousOrParentNode.queries)||parent&&parent.queries&&parent.queries.child(),isState=null!=state,node={flags:type,native:native,view:currentView,parent:parent,child:null,next:null,nodeInjector:parent?parent.nodeInjector:null,data:isState?state:null,queries:queries,tNode:null,pNextOrParent:null};return 2==(2&type)&&isState&&(ngDevMode&&assertNull(state.node,"LView.node should not have been initialized"),state.node=node),null!=index&&(ngDevMode&&assertDataNext(index),data[index]=node,index>=tData.length?tData[index]=null:node.tNode=tData[index],isParent?(currentQueries=null,previousOrParentNode.view!==currentView&&2!=(3&previousOrParentNode.flags)||(ngDevMode&&assertNull(previousOrParentNode.child,"previousOrParentNode's child should not have been set."),previousOrParentNode.child=node)):previousOrParentNode&&(ngDevMode&&assertNull(previousOrParentNode.next,"previousOrParentNode's next property should not have been set."),previousOrParentNode.next=node)),previousOrParentNode=node,isParent=!0,node}function renderEmbeddedTemplate(viewNode,template,context,renderer){var _isParent=isParent,_previousOrParentNode=previousOrParentNode;try{isParent=!0,previousOrParentNode=null;var cm=!1;if(null==viewNode)viewNode=createLNode(null,2,null,createLView(-1,renderer,{data:[],firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,hostBindings:null,components:null},template,context,2)),cm=!0;enterView(viewNode.data,viewNode),template(context,cm),refreshDynamicChildren(),refreshDirectives()}finally{leaveView(currentView.parent),isParent=_isParent,previousOrParentNode=_previousOrParentNode}return viewNode}function renderComponentOrTemplate(node,hostView,componentOrContext,template){var oldView=enterView(hostView,node);try{rendererFactory.begin&&rendererFactory.begin(),template?(template(componentOrContext,creationMode),refreshDirectives()):(executeInitAndContentHooks(),setHostBindings(rootDirectiveIndices),componentRefresh(1,0))}finally{rendererFactory.end&&rendererFactory.end(),leaveView(oldView)}}function queueHostBindingForCheck(dirIndex,elIndex){firstTemplatePass&&(currentView.tView.hostBindings||(currentView.tView.hostBindings=[])).push(dirIndex,elIndex)}function initChangeDetectorIfExisting(injector,instance){injector&&null!=injector.changeDetectorRef&&injector.changeDetectorRef._setComponentContext(instance)}function hack_declareDirectives(index,elIndex,directiveTypes,localRefs){if(directiveTypes)for(var i=0;i<directiveTypes.length;i++){index++;var directiveType=directiveTypes[i],directiveDef=firstTemplatePass?directiveType.ngDirectiveDef:tData[index],localNames=firstTemplatePass?findMatchingLocalNames(directiveDef,localRefs,index):null;directiveCreate(index,directiveDef.factory(),directiveDef,localNames),directiveDef.hostBindings&&queueHostBindingForCheck(index,elIndex)}}function findMatchingLocalNames(directiveDef,localRefs,index,defaultExport){var exportAs=directiveDef&&directiveDef.exportAs||defaultExport,matches=null;if(null!=exportAs&&localRefs)for(var i=0;i<localRefs.length;i+=2){var local=localRefs[i],toExportAs=localRefs[1|i];toExportAs!==exportAs&&toExportAs!==defaultExport||(matches||(matches=[])).push(local,index)}return matches}function getOrCreateTView(template){return template.ngPrivateData||(template.ngPrivateData={data:[],firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,hostBindings:null,components:null})}function setUpAttributes(native,attrs){ngDevMode&&assertEqual(attrs.length%2,0,"each attribute should have a key and a value");for(var isProc=isProceduralRenderer(renderer),i=0;i<attrs.length;i+=2){var attrName=attrs[i];if(attrName!==NG_PROJECT_AS_ATTR_NAME){var attrVal=attrs[i+1];isProc?renderer.setAttribute(native,attrName,attrVal):native.setAttribute(attrName,attrVal)}}}function createError(text,token){return new Error("Renderer: "+text+" ["+stringify$1(token)+"]")}function locateHostElement(factory,elementOrSelector){ngDevMode&&assertDataInRange(-1),rendererFactory=factory;var defaultRenderer=factory.createRenderer(null,null),rNode="string"==typeof elementOrSelector?isProceduralRenderer(defaultRenderer)?defaultRenderer.selectRootElement(elementOrSelector):defaultRenderer.querySelector(elementOrSelector):elementOrSelector;if(ngDevMode&&!rNode)throw createError("string"==typeof elementOrSelector?"Host node with selector not found:":"Host node is required:",elementOrSelector);return rNode}function hostElement(rNode,def){return isParent=!1,previousOrParentNode=null,createLNode(0,3,rNode,createLView(-1,renderer,getOrCreateTView(def.template),null,null,def.onPush?4:2))}function createTNode(tagName,attrs,data,localNames){return{tagName:tagName,attrs:attrs,localNames:localNames,initialInputs:void 0,inputs:void 0,outputs:void 0,data:data}}function generatePropertyAliases(lNodeFlags,direction){var size=(4092&lNodeFlags)>>2,propStore=null;if(size>0)for(var start=lNodeFlags>>12,isInput=0===direction,i=start,ii=start+size;i<ii;i++){var directiveDef=tData[i],propertyAliasMap=isInput?directiveDef.inputs:directiveDef.outputs;for(var publicName in propertyAliasMap)if(propertyAliasMap.hasOwnProperty(publicName)){propStore=propStore||{};var internalName=propertyAliasMap[publicName];propStore.hasOwnProperty(publicName)?propStore[publicName].push(i,internalName):propStore[publicName]=[i,internalName]}}return propStore}function directiveCreate(index,directive,directiveDef,localNames){var instance=baseDirectiveCreate(index,directive,directiveDef);ngDevMode&&assertNotNull(previousOrParentNode.tNode,"previousOrParentNode.tNode");var tNode=previousOrParentNode.tNode;return currentView.tView.firstTemplatePass&&localNames&&(tNode.localNames=tNode.localNames?tNode.localNames.concat(localNames):localNames),tNode&&tNode.attrs&&function(instance,inputs,tNode){var directiveIndex=((4092&previousOrParentNode.flags)>>2)-1,initialInputData=tNode.initialInputs;(void 0===initialInputData||directiveIndex>=initialInputData.length)&&(initialInputData=function(directiveIndex,inputs,tNode){var initialInputData=tNode.initialInputs||(tNode.initialInputs=[]);initialInputData[directiveIndex]=null;for(var attrs=tNode.attrs,i=0;i<attrs.length;i+=2){var attrName=attrs[i],minifiedInputName=inputs[attrName];if(void 0!==minifiedInputName){var inputsToStore=initialInputData[directiveIndex]||(initialInputData[directiveIndex]=[]);inputsToStore.push(minifiedInputName,attrs[1|i])}}return initialInputData}(directiveIndex,inputs,tNode));var initialInputs=initialInputData[directiveIndex];if(initialInputs)for(var i=0;i<initialInputs.length;i+=2)instance[initialInputs[i]]=initialInputs[1|i]}(instance,directiveDef.inputs,tNode),function(index,onInit,doCheck,tView){!0===tView.firstTemplatePass&&(null!=onInit&&(tView.initHooks||(tView.initHooks=[])).push(index,onInit),null!=doCheck&&((tView.initHooks||(tView.initHooks=[])).push(index,doCheck),(tView.checkHooks||(tView.checkHooks=[])).push(index,doCheck)))}(index,directiveDef.onInit,directiveDef.doCheck,currentView.tView),instance}function baseDirectiveCreate(index,directive,directiveDef){var instance;ngDevMode&&assertNull(currentView.bindingStartIndex,"directives should be created before any bindings"),ngDevMode&&assertPreviousIsParent();var flags=previousOrParentNode.flags;0===(4092&flags)?flags=index<<12|4|3&flags:flags+=4,previousOrParentNode.flags=flags,ngDevMode&&assertDataInRange(index-1),Object.defineProperty(directive,NG_HOST_SYMBOL,{enumerable:!1,value:previousOrParentNode}),data[index]=instance=directive,index>=tData.length&&(tData[index]=directiveDef);var diPublic=directiveDef.diPublic;return diPublic&&diPublic(directiveDef),null!=directiveDef.attributes&&3==(3&previousOrParentNode.flags)&&setUpAttributes(previousOrParentNode.native,directiveDef.attributes),instance}function refreshDynamicChildren(){for(var current=currentView.child;null!==current;current=current.next)if(0!==current.dynamicViewCount&&current.views)for(var container_1=current,i=0;i<container_1.views.length;i++){var view=container_1.views[i];renderEmbeddedTemplate(view,view.data.template,view.data.context,renderer)}}function componentRefresh(directiveIndex,elementIndex){ngDevMode&&assertDataInRange(elementIndex);var element=data[elementIndex];ngDevMode&&assertNodeType(element,3),ngDevMode&&assertNotNull(element.data,"Component's host node should have an LView attached.");var hostView=element.data;8==(8&hostView.flags)&&6&hostView.flags&&(ngDevMode&&assertDataInRange(directiveIndex),detectChangesInternal(hostView,element,getDirectiveInstance(data[directiveIndex])))}function appendToProjectionNode(projectionNode,appendedFirst,appendedLast){if(ngDevMode&&assertEqual(!!appendedFirst,!!appendedLast,"appendedFirst can be null if and only if appendedLast is also null"),appendedLast){var projectionNodeData=projectionNode.data;projectionNodeData.tail?projectionNodeData.tail.pNextOrParent=appendedFirst:projectionNodeData.head=appendedFirst,projectionNodeData.tail=appendedLast,appendedLast.pNextOrParent=projectionNode}}function findComponentHost(lView){for(var viewRootLNode=lView.node;2==(3&viewRootLNode.flags);)ngDevMode&&assertNotNull(lView.parent,"lView.parent"),viewRootLNode=(lView=lView.parent).node;return ngDevMode&&assertNodeType(viewRootLNode,3),ngDevMode&&assertNotNull(viewRootLNode.data,"node.data"),viewRootLNode}function addToViewTree(state){return currentView.tail?currentView.tail.next=state:currentView.child=state,currentView.tail=state,state}function markViewDirty(view){for(var currentView=view;null!=currentView.parent;)currentView.flags|=4,currentView=currentView.parent;currentView.flags|=4,ngDevMode&&assertNotNull(currentView.context,"rootContext"),function(rootContext){if(rootContext.clean==_CLEAN_PROMISE){var res_1;rootContext.clean=new Promise(function(r){return res_1=r}),rootContext.scheduler(function(){var component,rootView,rootComponent,hostNode;component=rootContext.component,rootView=function(component){ngDevMode&&assertNotNull(component,"component");var lView=_getComponentHostLElementNode(component).view;for(;lView.parent;)lView=lView.parent;return lView}(component),rootComponent=rootView.context.component,hostNode=_getComponentHostLElementNode(rootComponent),ngDevMode&&assertNotNull(hostNode.data,"Component host node should be attached to an LView"),renderComponentOrTemplate(hostNode,rootView,rootComponent),res_1(null),rootContext.clean=_CLEAN_PROMISE})}}(currentView.context)}function detectChanges(component){var hostNode=_getComponentHostLElementNode(component);ngDevMode&&assertNotNull(hostNode.data,"Component host node should be attached to an LView"),detectChangesInternal(hostNode.data,hostNode,component)}function throwErrorIfNoChangesMode(oldValue,currValue){if(checkNoChangesMode){var msg="ExpressionChangedAfterItHasBeenCheckedError: Expression has changed after it was checked. Previous value: '"+oldValue+"'. Current value: '"+currValue+"'.";throw creationMode&&(msg+=" It seems like the view has been created after its parent and its children have been dirty checked. Has it been created in a change detection hook ?"),new Error(msg)}}function detectChangesInternal(hostView,hostNode,component){var componentIndex=hostNode.flags>>12,template=hostNode.view.tView.data[componentIndex].template,oldView=enterView(hostView,hostNode);try{template(component,creationMode),refreshDynamicChildren(),refreshDirectives()}finally{leaveView(oldView)}}var NO_CHANGE={};function initBindings(){ngDevMode&&assertEqual(creationMode,!0,"should only be called in creationMode for performance reasons"),null==currentView.bindingStartIndex&&(bindingIndex=currentView.bindingStartIndex=data.length)}function store(index,value){index>=tData.length&&(tData[index]=null),data[index]=value}function load(index){return ngDevMode&&assertDataInRange(index,data),data[index]}function consumeBinding(){return ngDevMode&&assertDataInRange(bindingIndex),ngDevMode&&assertNotEqual(data[bindingIndex],NO_CHANGE,"Stored value should never be NO_CHANGE."),data[bindingIndex++]}function bindingUpdated(value){if(ngDevMode&&assertNotEqual(value,NO_CHANGE,"Incoming value should never be NO_CHANGE."),creationMode)initBindings();else{if(!isDifferent(data[bindingIndex],value))return bindingIndex++,!1;throwErrorIfNoChangesMode(data[bindingIndex],value)}return data[bindingIndex++]=value,!0}function checkAndUpdateBinding$1(value){return bindingUpdated(value),value}function bindingUpdated2(exp1,exp2){var different=bindingUpdated(exp1);return bindingUpdated(exp2)||different}function bindingUpdated4(exp1,exp2,exp3,exp4){var different=bindingUpdated2(exp1,exp2);return bindingUpdated2(exp3,exp4)||different}function getTView(){return currentView.tView}function getDirectiveInstance(instanceOrArray){return Array.isArray(instanceOrArray)?instanceOrArray[0]:instanceOrArray}function assertPreviousIsParent(){assertEqual(isParent,!0,"previousOrParentNode should be a parent")}function assertHasParent(){assertNotNull(previousOrParentNode.parent,"previousOrParentNode should have a parent")}function assertDataInRange(index,arr){null==arr&&(arr=data),assertLessThan(index,arr?arr.length:0,"index expected to be a valid data index")}function assertDataNext(index){assertEqual(data.length,index,"index expected to be at the end of data")}function _getComponentHostLElementNode(component){ngDevMode&&assertNotNull(component,"expecting component got null");var lElementNode=component[NG_HOST_SYMBOL];return ngDevMode&&assertNotNull(component,"object is not a component"),lElementNode}var CLEAN_PROMISE=_CLEAN_PROMISE,ViewRef$1=function(){function ViewRef(_view,context){this._view=_view,this.context=context}return ViewRef.prototype._setComponentContext=function(context){this.context=context},ViewRef.prototype.destroy=function(){notImplemented()},ViewRef.prototype.onDestroy=function(callback){notImplemented()},ViewRef.prototype.markForCheck=function(){markViewDirty(this._view)},ViewRef.prototype.detach=function(){this._view.flags&=-9},ViewRef.prototype.reattach=function(){this._view.flags|=8},ViewRef.prototype.detectChanges=function(){detectChanges(this.context)},ViewRef.prototype.checkNoChanges=function(){!function(component){checkNoChangesMode=!0;try{detectChanges(component)}finally{checkNoChangesMode=!1}}(this.context)},ViewRef}(),EmbeddedViewRef$1=function(_super){function EmbeddedViewRef(viewNode,template,context){var _this=_super.call(this,viewNode.data,context)||this;return _this._lViewNode=viewNode,_this}return __extends(EmbeddedViewRef,_super),EmbeddedViewRef}(ViewRef$1);
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function createViewRef(view,context){return addDestroyable(new ViewRef$1(view,context))}function addDestroyable(obj){var destroyFn=null;return obj.destroyed=!1,obj.destroy=function(){destroyFn&&destroyFn.forEach(function(fn){return fn()}),this.destroyed=!0},obj.onDestroy=function(fn){return(destroyFn||(destroyFn=[])).push(fn)},obj}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var NG_ELEMENT_ID="__NG_ELEMENT_ID__",BLOOM_SIZE=256,nextNgElementId=0;function getOrCreateNodeInjector(){return ngDevMode&&assertPreviousIsParent(),getOrCreateNodeInjectorForNode(getPreviousOrParentNode())}function getOrCreateNodeInjectorForNode(node){var nodeInjector=node.nodeInjector,parentInjector=node.parent&&node.parent.nodeInjector;return nodeInjector!=parentInjector?nodeInjector:node.nodeInjector={parent:parentInjector,node:node,bf0:0,bf1:0,bf2:0,bf3:0,bf4:0,bf5:0,bf6:0,bf7:0,cbf0:null==parentInjector?0:parentInjector.cbf0|parentInjector.bf0,cbf1:null==parentInjector?0:parentInjector.cbf1|parentInjector.bf1,cbf2:null==parentInjector?0:parentInjector.cbf2|parentInjector.bf2,cbf3:null==parentInjector?0:parentInjector.cbf3|parentInjector.bf3,cbf4:null==parentInjector?0:parentInjector.cbf4|parentInjector.bf4,cbf5:null==parentInjector?0:parentInjector.cbf5|parentInjector.bf5,cbf6:null==parentInjector?0:parentInjector.cbf6|parentInjector.bf6,cbf7:null==parentInjector?0:parentInjector.cbf7|parentInjector.bf7,injector:null,templateRef:null,viewContainerRef:null,elementRef:null,changeDetectorRef:null}}function createInjectionError(text$$1,token){return new Error("ElementInjector: "+text$$1+" ["+stringify$1(token)+"]")}function diPublicInInjector(di,def){!function(injector,type){var id=type[NG_ELEMENT_ID];null==id&&(id=type[NG_ELEMENT_ID]=nextNgElementId++);var bloomBit=id%BLOOM_SIZE,mask=1<<bloomBit;bloomBit<128?bloomBit<64?bloomBit<32?injector.bf0|=mask:injector.bf1|=mask:bloomBit<96?injector.bf2|=mask:injector.bf3|=mask:bloomBit<192?bloomBit<160?injector.bf4|=mask:injector.bf5|=mask:bloomBit<224?injector.bf6|=mask:injector.bf7|=mask}(di,def.type)}function diPublic(def){diPublicInInjector(getOrCreateNodeInjector(),def)}function getOrCreateChangeDetectorRef(di,context){if(di.changeDetectorRef)return di.changeDetectorRef;var currentNode=di.node;return null===currentNode.data?di.changeDetectorRef=function(currentNode){var hostNode=function(node){for(;2==(3&node.flags);)node=node.view.node;return node}(currentNode),hostInjector=hostNode.nodeInjector,existingRef=hostInjector&&hostInjector.changeDetectorRef;return existingRef||createViewRef(hostNode.data,hostNode.view.data[hostNode.flags>>12])}(currentNode.view.node):3==(3&currentNode.flags)?di.changeDetectorRef=createViewRef(currentNode.data,context):null}function getOrCreateInjectable(di,token,flags,defaultValue){var id,bloomHash="number"==typeof(id=token[NG_ELEMENT_ID])?id%BLOOM_SIZE:null;if(null===bloomHash){var moduleInjector=di.injector;if(!moduleInjector){if(null!=defaultValue)return defaultValue;throw createInjectionError("NotFound",token)}moduleInjector.get(token)}else for(var injector=di;injector&&(injector=bloomFindPossibleInjector(injector,bloomHash));){var node=injector.node,flags_1=node.flags,size=(4092&flags_1)>>2;if(0!==size)for(var start=flags_1>>12,tData=node.view.tView.data,i=start,ii=start+size;i<ii;i++){var directiveDef=tData[i];if(directiveDef.diPublic&&directiveDef.type==token)return getDirectiveInstance(node.view.data[i])}injector=injector.parent}throw createInjectionError("Not found",token)}function bloomFindPossibleInjector(startInjector,bloomBit){for(var mask=1<<bloomBit,injector=startInjector;injector;){if(((bloomBit<128?bloomBit<64?bloomBit<32?injector.bf0:injector.bf1:bloomBit<96?injector.bf2:injector.bf3:bloomBit<192?bloomBit<160?injector.bf4:injector.bf5:bloomBit<224?injector.bf6:injector.bf7)&mask)===mask)return injector;injector=(bloomBit<128?bloomBit<64?bloomBit<32?injector.cbf0:injector.cbf1:bloomBit<96?injector.cbf2:injector.cbf3:bloomBit<192?bloomBit<160?injector.cbf4:injector.cbf5:bloomBit<224?injector.cbf6:injector.cbf7)&mask?injector.parent:null}return null}var ReadFromInjectorFn=function(){return function(read){this.read=read}}();function getOrCreateElementRef(di){return di.elementRef||(di.elementRef=new ElementRef$1(0==(3&di.node.flags)?null:di.node.native))}new ReadFromInjectorFn(function(injector){return getOrCreateTemplateRef(injector)}),new ReadFromInjectorFn(function(injector){return getOrCreateContainerRef(injector)}),new ReadFromInjectorFn(function(injector){return getOrCreateElementRef(injector)}),new ReadFromInjectorFn(function(injector,node,directiveIdx){if(ngDevMode&&assertNodeOfPossibleTypes(node,0,3),directiveIdx>-1)return node.view.data[directiveIdx];if(3==(3&node.flags))return getOrCreateElementRef(injector);if(0==(3&node.flags))return getOrCreateTemplateRef(injector);throw new Error("fail")});var ElementRef$1=function(){return function(nativeElement){this.nativeElement=nativeElement}}();function getOrCreateContainerRef(di){return di.viewContainerRef||(di.viewContainerRef=new ViewContainerRef$1(di.node))}var ViewContainerRef$1=function(){function ViewContainerRef(_node){this._node=_node}return ViewContainerRef.prototype.clear=function(){throw notImplemented()},ViewContainerRef.prototype.get=function(index){throw notImplemented()},ViewContainerRef.prototype.createEmbeddedView=function(templateRef,context,index){var viewRef=templateRef.createEmbeddedView(context);return this.insert(viewRef,index),viewRef},ViewContainerRef.prototype.createComponent=function(componentFactory,index,injector,projectableNodes,ngModule){throw notImplemented()},ViewContainerRef.prototype.insert=function(viewRef,index){null==index?index=this._node.data.views.length:ngDevMode&&assertLessThan(index,this._node.data.views.length+1,"index");var lView=viewRef._lViewNode;return insertView(this._node,lView,index),this._node.data.nextIndex=this._node.data.views.length,null!==lView.data.template&&(this._node.data.dynamicViewCount++,null!==this._node.parent&&null!==this._node.parent.data&&(ngDevMode&&assertNodeOfPossibleTypes(this._node.parent,2,3),this._node.parent.data.dynamicViewCount++)),viewRef},ViewContainerRef.prototype.move=function(viewRef,currentIndex){throw notImplemented()},ViewContainerRef.prototype.indexOf=function(viewRef){throw notImplemented()},ViewContainerRef.prototype.remove=function(index){throw notImplemented()},ViewContainerRef.prototype.detach=function(index){throw notImplemented()},ViewContainerRef}();function getOrCreateTemplateRef(di){ngDevMode&&assertNodeType(di.node,0);var data=di.node.data;return di.templateRef||(di.templateRef=new TemplateRef$1(getOrCreateElementRef(di),data.template,renderer))}var TemplateRef$1=function(){function TemplateRef(elementRef,template,_renderer){this._renderer=_renderer,this.elementRef=elementRef,this._template=template}return TemplateRef.prototype.createEmbeddedView=function(context){var viewNode=renderEmbeddedTemplate(null,this._template,context,this._renderer);return addDestroyable(new EmbeddedViewRef$1(viewNode,this._template,context))},TemplateRef}();
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function defineComponent(componentDefinition){var type=componentDefinition.type,def={type:type,diPublic:null,factory:componentDefinition.factory,tag:componentDefinition.tag||null,template:componentDefinition.template||null,hostBindings:componentDefinition.hostBindings||null,attributes:componentDefinition.attributes||null,inputs:invertObject(componentDefinition.inputs),outputs:invertObject(componentDefinition.outputs),rendererType:resolveRendererType2(componentDefinition.rendererType)||null,exportAs:componentDefinition.exportAs,onInit:type.prototype.ngOnInit||null,doCheck:type.prototype.ngDoCheck||null,afterContentInit:type.prototype.ngAfterContentInit||null,afterContentChecked:type.prototype.ngAfterContentChecked||null,afterViewInit:type.prototype.ngAfterViewInit||null,afterViewChecked:type.prototype.ngAfterViewChecked||null,onDestroy:type.prototype.ngOnDestroy||null,onPush:componentDefinition.changeDetection===ChangeDetectionStrategy.OnPush},feature=componentDefinition.features;return feature&&feature.forEach(function(fn){return fn(def)}),def}var PRIVATE_PREFIX="__ngOnChanges_";var EMPTY$1={};function invertObject(obj){if(null==obj)return EMPTY$1;var newObj={};for(var minifiedKey in obj)newObj[obj[minifiedKey]]=minifiedKey;return newObj}var defineDirective=defineComponent;function pureFunction1(pureFn,exp,thisArg){return bindingUpdated(exp)?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp):pureFn(exp)):consumeBinding()}function pureFunction2(pureFn,exp1,exp2,thisArg){return bindingUpdated2(exp1,exp2)?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2):pureFn(exp1,exp2)):consumeBinding()}function pureFunction3(pureFn,exp1,exp2,exp3,thisArg){var different=bindingUpdated2(exp1,exp2);return bindingUpdated(exp3)||different?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3):pureFn(exp1,exp2,exp3)):consumeBinding()}function pureFunction4(pureFn,exp1,exp2,exp3,exp4,thisArg){return bindingUpdated4(exp1,exp2,exp3,exp4)?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4):pureFn(exp1,exp2,exp3,exp4)):consumeBinding()}function pureFunctionV(pureFn,exps,thisArg){for(var different=!1,i=0;i<exps.length;i++)bindingUpdated(exps[i])&&(different=!0);return different?checkAndUpdateBinding$1(pureFn.apply(thisArg,exps)):consumeBinding()}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function isPure(index){return getTView().data[index].pure}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var LQueries_=function(){function LQueries_(deep){this.shallow=null,this.deep=null,this.deep=null==deep?null:deep}return LQueries_.prototype.track=function(queryList,predicate,descend,read){descend?this.deep=createQuery$1(this.deep,queryList,predicate,null!=read?read:null):this.shallow=createQuery$1(this.shallow,queryList,predicate,null!=read?read:null)},LQueries_.prototype.child=function(){return null===this.deep?null:null===this.shallow?this:new LQueries_(this.deep)},LQueries_.prototype.container=function(){for(var result=null,query=this.deep;query;){var containerValues=[];query.values.push(containerValues);var clonedQuery={next:null,list:query.list,predicate:query.predicate,values:containerValues};clonedQuery.next=result,result=clonedQuery,query=query.next}return result?new LQueries_(result):null},LQueries_.prototype.enterView=function(index){for(var result=null,query=this.deep;query;){var viewValues=[];query.values.splice(index,0,viewValues);var clonedQuery={next:null,list:query.list,predicate:query.predicate,values:viewValues};clonedQuery.next=result,result=clonedQuery,query=query.next}return result?new LQueries_(result):null},LQueries_.prototype.addNode=function(node){add(this.shallow,node),add(this.deep,node)},LQueries_.prototype.removeView=function(index){for(var query=this.deep;query;){var removed=query.values.splice(index,1);ngDevMode&&assertEqual(removed.length,1,"removed.length"),removed[0].length&&query.list.setDirty(),query=query.next}},LQueries_}();function getIdxOfMatchingSelector(tNode,selector){var localNames=tNode.localNames;if(localNames)for(var i=0;i<localNames.length;i+=2)if(localNames[i]===selector)return localNames[i+1];return null}function geIdxOfMatchingDirective(node,type){for(var tData=node.view.tView.data,flags=node.flags,i=flags>>12,ii=i+((4092&flags)>>2);i<ii;i++){var def=tData[i];if(def.diPublic&&def.type===type)return i}return null}function readFromNodeInjector(nodeInjector,node,read,directiveIdx){if(read instanceof ReadFromInjectorFn)return read.read(nodeInjector,node,directiveIdx);var matchingIdx=geIdxOfMatchingDirective(node,read);return null!==matchingIdx?node.view.data[matchingIdx]:null}function add(query,node){for(var nodeInjector=getOrCreateNodeInjectorForNode(node);query;){var predicate=query.predicate,type=predicate.type;if(type){if(null!==(directiveIdx=geIdxOfMatchingDirective(node,type)))null!==(result=readFromNodeInjector(nodeInjector,node,predicate.read||type,directiveIdx))&&addMatch(query,result)}else for(var selector=predicate.selector,i=0;i<selector.length;i++){var directiveIdx,result;if(ngDevMode&&assertNotNull(node.tNode,"node.tNode"),null!==(directiveIdx=getIdxOfMatchingSelector(node.tNode,selector[i])))ngDevMode&&assertNotNull(predicate.read,"the node should have a predicate"),null!==(result=readFromNodeInjector(nodeInjector,node,predicate.read,directiveIdx))&&addMatch(query,result)}query=query.next}}function addMatch(query,matchingValue){query.values.push(matchingValue),query.list.setDirty()}function createQuery$1(previous,queryList,predicate,read){return{next:previous,list:queryList,predicate:function(predicate,read){var isArray=Array.isArray(predicate);return{type:isArray?null:predicate,selector:isArray?predicate:null,read:read}}(predicate,read),values:queryList._valuesTree}}var QueryList$1=function(){function QueryList_(){this.dirty=!0,this.changes=new EventEmitter,this._values=[],this._valuesTree=[]}return Object.defineProperty(QueryList_.prototype,"length",{get:function(){return this._values.length},enumerable:!0,configurable:!0}),Object.defineProperty(QueryList_.prototype,"first",{get:function(){var values=this._values;return values.length?values[0]:null},enumerable:!0,configurable:!0}),Object.defineProperty(QueryList_.prototype,"last",{get:function(){var values=this._values;return values.length?values[values.length-1]:null},enumerable:!0,configurable:!0}),QueryList_.prototype.map=function(fn){return this._values.map(fn)},QueryList_.prototype.filter=function(fn){return this._values.filter(fn)},QueryList_.prototype.find=function(fn){return this._values.find(fn)},QueryList_.prototype.reduce=function(fn,init){return this._values.reduce(fn,init)},QueryList_.prototype.forEach=function(fn){this._values.forEach(fn)},QueryList_.prototype.some=function(fn){return this._values.some(fn)},QueryList_.prototype.toArray=function(){return this._values.slice(0)},QueryList_.prototype[getSymbolIterator()]=function(){return this._values[getSymbolIterator()]()},QueryList_.prototype.toString=function(){return this._values.toString()},QueryList_.prototype.reset=function(res){this._values=function(list){for(var result=[],i=0;i<list.length;){var item=list[i];Array.isArray(item)?item.length>0?(list=item.concat(list.slice(i+1)),i=0):i++:(result.push(item),i++)}return result}(res),this.dirty=!1},QueryList_.prototype.notifyOnChanges=function(){this.changes.emit(this)},QueryList_.prototype.setDirty=function(){this.dirty=!0},QueryList_.prototype.destroy=function(){this.changes.complete(),this.changes.unsubscribe()},QueryList_}();
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */,exports.ɵdetectChanges=detectChanges,exports.ɵrenderComponent=function(componentType,opts){var msg;void 0===opts&&(opts={}),ngDevMode&&(void 0===msg&&(msg="Type passed in is not ComponentType, it does not have 'ngComponentDef' property."),componentType.ngComponentDef||throwError(msg));var component,rendererFactory=opts.rendererFactory||domRendererFactory3,componentDef=componentType.ngComponentDef;componentDef.type!=componentType&&(componentDef.type=componentType);var elementNode,hostNode=locateHostElement(rendererFactory,opts.host||componentDef.tag),rootContext={component:null,scheduler:opts.scheduler||requestAnimationFrame,clean:CLEAN_PROMISE},rootView=createLView(-1,rendererFactory.createRenderer(hostNode,componentDef.rendererType),{data:[],firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,hostBindings:null,components:null},null,rootContext,componentDef.onPush?4:2),oldView=enterView(rootView,null);try{elementNode=hostElement(hostNode,componentDef),component=rootContext.component=baseDirectiveCreate(1,componentDef.factory(),componentDef),initChangeDetectorIfExisting(elementNode.nodeInjector,component)}finally{enterView(oldView,null)}return opts.hostFeatures&&opts.hostFeatures.forEach(function(feature){return feature(component,componentDef)}),renderComponentOrTemplate(elementNode,rootView,component),component},exports.ɵdirectiveInject=function(token,flags,defaultValue){return getOrCreateInjectable(getOrCreateNodeInjector(),token,0,defaultValue)},exports.ɵinjectTemplateRef=function(){return getOrCreateTemplateRef(getOrCreateNodeInjector())},exports.ɵinjectViewContainerRef=function(){return getOrCreateContainerRef(getOrCreateNodeInjector())},exports.ɵinjectChangeDetectorRef=function(){return getOrCreateChangeDetectorRef(getOrCreateNodeInjector(),null)},exports.ɵinjectAttribute=function(attrName){ngDevMode&&assertPreviousIsParent();var lElement=getPreviousOrParentNode();ngDevMode&&assertNodeType(lElement,3);var tElement=lElement.tNode;ngDevMode&&assertNotNull(tElement,"expecting tNode");var attrs=tElement.attrs;if(attrs)for(var i=0;i<attrs.length;i+=2)if(attrs[i]==attrName)return attrs[i+1]},exports.ɵPublicFeature=function(definition){definition.diPublic=diPublic},exports.ɵNgOnChangesFeature=function(inputPropertyNames){return function(definition){var inputs=definition.inputs,proto=definition.type.prototype;Object.defineProperty(proto,PRIVATE_PREFIX,{value:void 0,writable:!0});var _loop_1=function(pubKey){var minKey=inputs[pubKey],propertyName=inputPropertyNames&&inputPropertyNames[minKey]||pubKey,privateMinKey=PRIVATE_PREFIX+minKey;Object.defineProperty(proto,privateMinKey,{value:void 0,writable:!0});var existingDesc=Object.getOwnPropertyDescriptor(proto,minKey);Object.defineProperty(proto,minKey,{get:function(){return existingDesc&&existingDesc.get?existingDesc.get.call(this):this[privateMinKey]},set:function(value){var simpleChanges=this[PRIVATE_PREFIX],isFirstChange=void 0===simpleChanges;null==simpleChanges&&(simpleChanges=this[PRIVATE_PREFIX]={}),simpleChanges[propertyName]=new SimpleChange(this[privateMinKey],value,isFirstChange),existingDesc&&existingDesc.set?existingDesc.set.call(this,value):this[privateMinKey]=value}})};for(var pubKey in inputs)_loop_1(pubKey);null!=definition.onInit&&(definition.onInit=onChangesWrapper(definition.onInit)),definition.doCheck=onChangesWrapper(definition.doCheck)};function onChangesWrapper(delegateHook){return function(){var simpleChanges=this[PRIVATE_PREFIX];null!=simpleChanges&&(this.ngOnChanges(simpleChanges),this[PRIVATE_PREFIX]=null),delegateHook&&delegateHook.apply(this)}}},exports.ɵNC=NO_CHANGE,exports.ɵC=function(index,directiveTypes,template,tagName,attrs,localRefs){ngDevMode&&assertNull(currentView.bindingStartIndex,"container nodes should be created before any bindings");var currentParent=isParent?previousOrParentNode:previousOrParentNode.parent;ngDevMode&&assertNotNull(currentParent,"containers should have a parent");var lContainer={views:[],nextIndex:0,renderParent:canInsertNativeNode(currentParent,currentView)?currentParent:null,template:null==template?null:template,next:null,parent:currentView,dynamicViewCount:0,queries:null},node=createLNode(index,0,void 0,lContainer);if(null==node.tNode){var localNames=findMatchingLocalNames(null,localRefs,-1,"");node.tNode=tData[index]=createTNode(tagName||null,attrs||null,[],localNames)}addToViewTree(node.data),hack_declareDirectives(index,index,directiveTypes,localRefs),isParent=!1,ngDevMode&&assertNodeType(previousOrParentNode,0);var queries=node.queries;queries&&(queries.addNode(node),lContainer.queries=queries.container())},exports.ɵE=function(index,nameOrComponentType,attrs,directiveTypes,localRefs){var node,native,elIndex;if(null==nameOrComponentType){var node_1=data[index];native=node_1&&node_1.native}else{ngDevMode&&assertNull(currentView.bindingStartIndex,"elements should be created before any bindings");var isHostElement="string"!=typeof nameOrComponentType,hostComponentDef=null,name_1=nameOrComponentType;if(isHostElement&&(name_1=(hostComponentDef=firstTemplatePass?nameOrComponentType.ngComponentDef:tData[index+1]).tag),null===name_1)throw"for now name is required";native=renderer.createElement(name_1);var componentView=null;if(isHostElement){var tView=getOrCreateTView(hostComponentDef.template);componentView=addToViewTree(createLView(-1,rendererFactory.createRenderer(native,hostComponentDef.rendererType),tView,null,null,hostComponentDef.onPush?4:2))}if(null==(node=createLNode(index,3,native,componentView)).tNode){var localNames=findMatchingLocalNames(hostComponentDef,localRefs,isHostElement?index+1:-1,"");ngDevMode&&assertDataInRange(index-1),node.tNode=tData[index]=createTNode(name_1,attrs||null,null,localNames)}attrs&&setUpAttributes(native,attrs),appendChild(node.parent,native,currentView);var elementIndex=index;if(hostComponentDef){var instance=hostComponentDef.factory();directiveCreate(++index,instance,hostComponentDef,null),initChangeDetectorIfExisting(node.nodeInjector,instance),elIndex=elementIndex,firstTemplatePass&&(currentView.tView.components||(currentView.tView.components=[])).push(elIndex),hostComponentDef.hostBindings&&queueHostBindingForCheck(index,elementIndex)}hack_declareDirectives(index,elementIndex,directiveTypes,localRefs)}return native},exports.ɵL=function(eventName,listenerFn,useCapture){void 0===useCapture&&(useCapture=!1),ngDevMode&&assertPreviousIsParent();var node=previousOrParentNode,native=node.native,cleanupFns=cleanup||(cleanup=currentView.cleanup=[]);if(isProceduralRenderer(renderer)){var wrappedListener=function(view,listenerFn){return function(e){return markViewDirty(view),listenerFn(e)}}(currentView,listenerFn),cleanupFn=renderer.listen(native,eventName,wrappedListener);cleanupFns.push(cleanupFn,null)}else wrappedListener=function(view,listenerFn){return function(e){markViewDirty(view),!1===listenerFn(e)&&(e.preventDefault(),e.returnValue=!1)}}(currentView,listenerFn),native.addEventListener(eventName,wrappedListener,useCapture),cleanupFns.push(eventName,native,wrappedListener,useCapture);var tNode=node.tNode;void 0===tNode.outputs&&(tNode.outputs=generatePropertyAliases(node.flags,1));var outputData,outputs=tNode.outputs;outputs&&(outputData=outputs[eventName])&&function(outputs,listener){for(var i=0;i<outputs.length;i+=2){ngDevMode&&assertDataInRange(outputs[i]);var subscription=data[outputs[i]][outputs[1|i]].subscribe(listener);cleanup.push(subscription.unsubscribe,subscription)}}(outputData,listenerFn)},exports.ɵT=function(index,value){ngDevMode&&assertNull(currentView.bindingStartIndex,"text nodes should be created before bindings");var textNode=null!=value?isProceduralRenderer(renderer)?renderer.createText(stringify$1(value)):renderer.createTextNode(stringify$1(value)):null,node=createLNode(index,3,textNode);isParent=!1,appendChild(node.parent,textNode,currentView)},exports.ɵV=function(viewBlockId){var container=isParent?previousOrParentNode:previousOrParentNode.parent;ngDevMode&&assertNodeType(container,0);var lContainer=container.data,existingViewNode=function(containerNode,startIdx,viewBlockId){for(var views=containerNode.data.views,i=startIdx;i<views.length;i++){var viewAtPositionId=views[i].data.id;if(viewAtPositionId===viewBlockId)return views[i];if(!(viewAtPositionId<viewBlockId))break;removeView(containerNode,i)}return null}(container,lContainer.nextIndex,viewBlockId);if(existingViewNode)previousOrParentNode=existingViewNode,ngDevMode&&assertNodeType(previousOrParentNode,2),isParent=!0,enterView(existingViewNode.data,existingViewNode);else{var newView=createLView(viewBlockId,renderer,function(viewIndex,parent){ngDevMode&&assertNodeType(parent,0);var tContainer=parent.tNode.data;return(viewIndex>=tContainer.length||null==tContainer[viewIndex])&&(tContainer[viewIndex]={data:[],firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,hostBindings:null,components:null}),tContainer[viewIndex]}(viewBlockId,container),null,null,2);lContainer.queries&&(newView.queries=lContainer.queries.enterView(lContainer.nextIndex)),enterView(newView,createLNode(null,2,null,newView))}return!existingViewNode},exports.ɵQ=function(memoryIndex,predicate,descend,read){ngDevMode&&assertPreviousIsParent();var queryList=new QueryList$1;return(currentQueries||(currentQueries=new LQueries_)).track(queryList,predicate,descend,read),null!=memoryIndex&&store(memoryIndex,queryList),queryList},exports.ɵP=function(nodeIndex,localIndex,selectorIndex,attrs){void 0===selectorIndex&&(selectorIndex=0);var node=createLNode(nodeIndex,1,null,{head:null,tail:null});null==node.tNode&&(node.tNode=createTNode(null,attrs||null,null,null)),isParent=!1;for(var currentParent=node.parent,nodesForSelector=findComponentHost(currentView).data.data[localIndex][selectorIndex],i=0;i<nodesForSelector.length;i++)if(1==(3&(nodeToProject=nodesForSelector[i]).flags)){var previouslyProjected=nodeToProject.data;appendToProjectionNode(node,previouslyProjected.head,previouslyProjected.tail)}else appendToProjectionNode(node,nodeToProject,nodeToProject);if(canInsertNativeNode(currentParent,currentView))for(var nodeToProject=node.data.head,lastNodeToProject=node.data.tail;nodeToProject;)appendProjectedNode(nodeToProject,currentParent,currentView),nodeToProject=nodeToProject===lastNodeToProject?null:nodeToProject.pNextOrParent},exports.ɵb=function(value){if(creationMode)return initBindings(),data[bindingIndex++]=value;var changed=value!==NO_CHANGE&&isDifferent(data[bindingIndex],value);return changed&&(throwErrorIfNoChangesMode(data[bindingIndex],value),data[bindingIndex]=value),bindingIndex++,changed?value:NO_CHANGE},exports.ɵi1=function(prefix,v0,suffix){return bindingUpdated(v0)?prefix+stringify$1(v0)+suffix:NO_CHANGE},exports.ɵi2=function(prefix,v0,i0,v1,suffix){return bindingUpdated2(v0,v1)?prefix+stringify$1(v0)+i0+stringify$1(v1)+suffix:NO_CHANGE},exports.ɵi3=function(prefix,v0,i0,v1,i1,v2,suffix){var different=bindingUpdated2(v0,v1);return(different=bindingUpdated(v2)||different)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+suffix:NO_CHANGE},exports.ɵi4=function(prefix,v0,i0,v1,i1,v2,i2,v3,suffix){return bindingUpdated4(v0,v1,v2,v3)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+suffix:NO_CHANGE},exports.ɵi5=function(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,suffix){var different=bindingUpdated4(v0,v1,v2,v3);return(different=bindingUpdated(v4)||different)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+suffix:NO_CHANGE},exports.ɵi6=function(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,suffix){var different=bindingUpdated4(v0,v1,v2,v3);return(different=bindingUpdated2(v4,v5)||different)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+suffix:NO_CHANGE},exports.ɵi7=function(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,i5,v6,suffix){var different=bindingUpdated4(v0,v1,v2,v3);return different=bindingUpdated2(v4,v5)||different,(different=bindingUpdated(v6)||different)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+i5+stringify$1(v6)+suffix:NO_CHANGE},exports.ɵi8=function(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,i5,v6,i6,v7,suffix){var different=bindingUpdated4(v0,v1,v2,v3);return(different=bindingUpdated4(v4,v5,v6,v7)||different)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+i5+stringify$1(v6)+i6+stringify$1(v7)+suffix:NO_CHANGE},exports.ɵiV=function(values){ngDevMode&&assertLessThan(2,values.length,"should have at least 3 values"),ngDevMode&&assertEqual(values.length%2,1,"should have an odd number of values");for(var different=!1,i=1;i<values.length;i+=2)bindingUpdated(values[i])&&(different=!0);if(!different)return NO_CHANGE;var content=values[0];for(i=1;i<values.length;i+=2)content+=stringify$1(values[i])+values[i+1];return content},exports.ɵpb1=function(index,v1){var pipeInstance=load(index);return isPure(index)?pureFunction1(pipeInstance.transform,v1,pipeInstance):pipeInstance.transform(v1)},exports.ɵpb2=function(index,v1,v2){var pipeInstance=load(index);return isPure(index)?pureFunction2(pipeInstance.transform,v1,v2,pipeInstance):pipeInstance.transform(v1,v2)},exports.ɵpb3=function(index,v1,v2,v3){var pipeInstance=load(index);return isPure(index)?pureFunction3(pipeInstance.transform.bind(pipeInstance),v1,v2,v3):pipeInstance.transform(v1,v2,v3)},exports.ɵpb4=function(index,v1,v2,v3,v4){var pipeInstance=load(index);return isPure(index)?pureFunction4(pipeInstance.transform,v1,v2,v3,v4,pipeInstance):pipeInstance.transform(v1,v2,v3,v4)},exports.ɵpbV=function(index,values){var pipeInstance=load(index);return isPure(index)?pureFunctionV(pipeInstance.transform,values,pipeInstance):pipeInstance.transform.apply(pipeInstance,values)},exports.ɵf0=function(pureFn,thisArg){return getCreationMode()?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg):pureFn()):consumeBinding()},exports.ɵf1=pureFunction1,exports.ɵf2=pureFunction2,exports.ɵf3=pureFunction3,exports.ɵf4=pureFunction4,exports.ɵf5=function(pureFn,exp1,exp2,exp3,exp4,exp5,thisArg){var different=bindingUpdated4(exp1,exp2,exp3,exp4);return bindingUpdated(exp5)||different?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5):pureFn(exp1,exp2,exp3,exp4,exp5)):consumeBinding()},exports.ɵf6=function(pureFn,exp1,exp2,exp3,exp4,exp5,exp6,thisArg){var different=bindingUpdated4(exp1,exp2,exp3,exp4);return bindingUpdated2(exp5,exp6)||different?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5,exp6):pureFn(exp1,exp2,exp3,exp4,exp5,exp6)):consumeBinding()},exports.ɵf7=function(pureFn,exp1,exp2,exp3,exp4,exp5,exp6,exp7,thisArg){var different=bindingUpdated4(exp1,exp2,exp3,exp4);return different=bindingUpdated2(exp5,exp6)||different,bindingUpdated(exp7)||different?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5,exp6,exp7):pureFn(exp1,exp2,exp3,exp4,exp5,exp6,exp7)):consumeBinding()},exports.ɵf8=function(pureFn,exp1,exp2,exp3,exp4,exp5,exp6,exp7,exp8,thisArg){var different=bindingUpdated4(exp1,exp2,exp3,exp4);return bindingUpdated4(exp5,exp6,exp7,exp8)||different?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5,exp6,exp7,exp8):pureFn(exp1,exp2,exp3,exp4,exp5,exp6,exp7,exp8)):consumeBinding()},exports.ɵfV=pureFunctionV,exports.ɵcR=function(index){ngDevMode&&assertDataInRange(index),previousOrParentNode=data[index],ngDevMode&&assertNodeType(previousOrParentNode,0),isParent=!0,previousOrParentNode.data.nextIndex=0,ngDevMode&&void 0!==previousOrParentNode.native&&throwError("the container's native element should not have been set yet."),checkNoChangesMode||executeInitHooks(currentView,currentView.tView,creationMode)},exports.ɵcr=function(){isParent?isParent=!1:(ngDevMode&&assertNodeType(previousOrParentNode,2),ngDevMode&&assertHasParent(),previousOrParentNode=previousOrParentNode.parent),ngDevMode&&assertNodeType(previousOrParentNode,0);var container=previousOrParentNode;container.native=void 0,ngDevMode&&assertNodeType(container,0);for(var nextIndex=container.data.nextIndex;nextIndex<container.data.views.length;)removeView(container,nextIndex)},exports.ɵqR=function(queryList){var queryListImpl=queryList;return!!queryList.dirty&&(queryList.reset(queryListImpl._valuesTree),queryList.notifyOnChanges(),!0)},exports.ɵe=function(){isParent?isParent=!1:(ngDevMode&&assertHasParent(),previousOrParentNode=previousOrParentNode.parent),ngDevMode&&assertNodeType(previousOrParentNode,3);var queries=previousOrParentNode.queries;queries&&queries.addNode(previousOrParentNode),function(flags,currentView){var tView=currentView.tView;if(!0===tView.firstTemplatePass)for(var start=flags>>12,i=start,end=start+((4092&flags)>>2);i<end;i++){var def=tView.data[i];queueContentHooks(def,tView,i),queueViewHooks(def,tView,i),queueDestroyHooks(def,tView,i)}}(previousOrParentNode.flags,currentView)},exports.ɵp=function(index,propName,value,sanitizer){if(value!==NO_CHANGE){var node=data[index],tNode=node.tNode;tNode&&void 0===tNode.inputs&&(tNode.inputs=generatePropertyAliases(node.flags,0));var dataValue,inputData=tNode&&tNode.inputs;if(inputData&&(dataValue=inputData[propName]))!function(inputs,value){for(var i=0;i<inputs.length;i+=2)ngDevMode&&assertDataInRange(inputs[i]),data[inputs[i]][inputs[1|i]]=value}(dataValue,value),function(node){!node.data||2&node.data.flags||(node.data.flags|=4)}(node);else{value=null!=sanitizer?sanitizer(value):value;var native=node.native;isProceduralRenderer(renderer)?renderer.setProperty(native,propName,value):native.setProperty?native.setProperty(propName,value):native[propName]=value}}},exports.ɵpD=function(index,selectors,textSelectors){for(var noOfNodeBuckets=selectors?selectors.length+1:1,distributedNodes=new Array(noOfNodeBuckets),i=0;i<noOfNodeBuckets;i++)distributedNodes[i]=[];for(var componentChild=findComponentHost(currentView).child;null!==componentChild;)selectors&&componentChild.tNode?distributedNodes[matchingSelectorIndex(componentChild.tNode,selectors,textSelectors)].push(componentChild):distributedNodes[0].push(componentChild),componentChild=componentChild.next;ngDevMode&&assertDataNext(index),data[index]=distributedNodes},exports.ɵa=function(index,name,value,sanitizer){if(value!==NO_CHANGE){var element=data[index];if(null==value)isProceduralRenderer(renderer)?renderer.removeAttribute(element.native,name):element.native.removeAttribute(name);else{var strValue=null==sanitizer?stringify$1(value):sanitizer(value);isProceduralRenderer(renderer)?renderer.setAttribute(element.native,name,strValue):element.native.setAttribute(name,strValue)}}},exports.ɵs=function(index,value){if(value!==NO_CHANGE){var lElement=data[index];if(isProceduralRenderer(renderer))renderer.setProperty(lElement.native,"style",value);else for(var style=lElement.native.style,i=0,keys=Object.keys(value);i<keys.length;i++){var styleName=keys[i],styleValue=value[styleName];null==styleValue?style.removeProperty(styleName):style.setProperty(styleName,styleValue)}}},exports.ɵsn=function(index,styleName,value,suffixOrSanitizer){if(value!==NO_CHANGE){var lElement=data[index];if(null==value)isProceduralRenderer(renderer)?renderer.removeStyle(lElement.native,styleName,RendererStyleFlags3.DashCase):lElement.native.style.removeProperty(styleName);else{var strValue="function"==typeof suffixOrSanitizer?suffixOrSanitizer(value):stringify$1(value);"string"==typeof suffixOrSanitizer&&(strValue+=suffixOrSanitizer),isProceduralRenderer(renderer)?renderer.setStyle(lElement.native,styleName,strValue,RendererStyleFlags3.DashCase):lElement.native.style.setProperty(styleName,strValue)}}},exports.ɵk=function(index,value){if(value!==NO_CHANGE){var lElement=data[index];isProceduralRenderer(renderer)?renderer.setProperty(lElement.native,"className",value):lElement.native.className=stringify$1(value)}},exports.ɵkn=function(index,className,value){if(value!==NO_CHANGE){var lElement=data[index];value?isProceduralRenderer(renderer)?renderer.addClass(lElement.native,className):lElement.native.classList.add(className):isProceduralRenderer(renderer)?renderer.removeClass(lElement.native,className):lElement.native.classList.remove(className)}},exports.ɵt=function(index,value){ngDevMode&&assertDataInRange(index);var existingNode=data[index];ngDevMode&&assertNotNull(existingNode,"existing node"),existingNode.native?value!==NO_CHANGE&&(isProceduralRenderer(renderer)?renderer.setValue(existingNode.native,stringify$1(value)):existingNode.native.textContent=stringify$1(value)):(existingNode.native=isProceduralRenderer(renderer)?renderer.createText(stringify$1(value)):renderer.createTextNode(stringify$1(value)),function(node,currentView){var parent=node.parent;if(canInsertNativeNode(parent,currentView)){var nativeSibling=findNextRNodeSibling(node,null),renderer=currentView.renderer;isProceduralRenderer(renderer)?renderer.insertBefore(parent.native,node.native,nativeSibling):parent.native.insertBefore(node.native,nativeSibling,!1)}}(existingNode,currentView))},exports.ɵv=function(){refreshDirectives(),isParent=!1;var viewNode=previousOrParentNode=currentView.node,containerNode=previousOrParentNode.parent;if(containerNode){ngDevMode&&assertNodeType(viewNode,2),ngDevMode&&assertNodeType(containerNode,0);var lContainer=containerNode.data;creationMode&&insertView(containerNode,viewNode,lContainer.nextIndex),lContainer.nextIndex++}leaveView(currentView.parent),ngDevMode&&assertEqual(isParent,!1,"isParent"),ngDevMode&&assertNodeType(previousOrParentNode,2)},exports.ɵst=store,exports.ɵld=load,exports.ɵPp=function(index,pipeDef,firstInstance){var tView=getTView();tView.firstTemplatePass&&(tView.data[index]=pipeDef,null!=pipeDef.onDestroy&&(tView.destroyHooks||(tView.destroyHooks=[])).push(index,pipeDef.onDestroy));var pipeInstance=pipeDef.pure&&firstInstance?firstInstance:pipeDef.n();return store(index,pipeInstance),pipeInstance},exports.ɵbypassSanitizationTrustHtml=function(trustedHtml){return bypassSanitizationTrustString(trustedHtml,"Html")},exports.ɵbypassSanitizationTrustStyle=function(trustedStyle){return bypassSanitizationTrustString(trustedStyle,"Style")},exports.ɵbypassSanitizationTrustScript=function(trustedScript){return bypassSanitizationTrustString(trustedScript,"Script")},exports.ɵbypassSanitizationTrustUrl=function(trustedUrl){return bypassSanitizationTrustString(trustedUrl,"Url")},exports.ɵbypassSanitizationTrustResourceUrl=function(trustedResourceUrl){return bypassSanitizationTrustString(trustedResourceUrl,"ResourceUrl")},exports.ɵsanitizeHtml=function(unsafeHtml){return unsafeHtml instanceof String&&"Html"===unsafeHtml[BRAND]?unsafeHtml.toString():_sanitizeHtml(document,stringify$1(unsafeHtml))},exports.ɵsanitizeStyle=function(unsafeStyle){return unsafeStyle instanceof String&&"Style"===unsafeStyle[BRAND]?unsafeStyle.toString():_sanitizeStyle(stringify$1(unsafeStyle))},exports.ɵsanitizeUrl=function(unsafeUrl){return unsafeUrl instanceof String&&"Url"===unsafeUrl[BRAND]?unsafeUrl.toString():_sanitizeUrl(stringify$1(unsafeUrl))},exports.ɵsanitizeResourceUrl=function(unsafeResourceUrl){if(unsafeResourceUrl instanceof String&&"ResourceUrl"===unsafeResourceUrl[BRAND])return unsafeResourceUrl.toString();throw new Error("unsafe value used in a resource URL context (see http://g.co/ng/security#xss)")},exports.ɵregisterModuleFactory=function(id,factory){var existing=moduleFactories.get(id);if(existing)throw new Error("Duplicate module registered for "+id+" - "+existing.moduleType.name+" vs "+factory.moduleType.name);moduleFactories.set(id,factory)},exports.ɵEMPTY_ARRAY=[],exports.ɵEMPTY_MAP={},exports.ɵand=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
