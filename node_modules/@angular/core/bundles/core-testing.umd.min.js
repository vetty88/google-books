 ...
 * found in the LICENSE file at https://angular.io/license
 */
var _global$1="undefined"==typeof window?global:window;_global$1.beforeEach&&_global$1.beforeEach(function(){TestBed.resetTestingModule(),resetFakeAsyncZone()});var savedDocument=void 0,savedRequestAnimationFrame=void 0,savedNode=void 0,requestAnimationFrameCount=0,ɵ0=function(domino){if("object"==typeof global&&global.process&&"function"==typeof require)try{return require(domino)}catch(e){}return null},domino=ɵ0("domino");function ensureDocument(){if(domino){var window_1=domino.createWindow("","http://localhost");savedDocument=global.document,global.document=window_1.document,global.Event=null,savedNode=global.Node,global.Node=domino.impl.Node,savedRequestAnimationFrame=global.requestAnimationFrame,global.requestAnimationFrame=function(cb){return setImmediate(cb),requestAnimationFrameCount++}}}function cleanupDocument(){savedDocument&&(global.document=savedDocument,savedDocument=void 0),savedNode&&(global.Node=savedNode,savedNode=void 0),savedRequestAnimationFrame&&(global.requestAnimationFrame=savedRequestAnimationFrame,savedRequestAnimationFrame=void 0)}"function"==typeof beforeEach&&beforeEach(ensureDocument),"function"==typeof afterEach&&beforeEach(cleanupDocument),exports.async=function(fn){return _global.jasmine?function(done){done||((done=function(){}).fail=function(e){throw e}),runInTestZone(fn,this,done,function(err){if("string"==typeof err)return done.fail(new Error(err));done.fail(err)})}:function(){var _this=this;return new Promise(function(finishCallback,failCallback){runInTestZone(fn,_this,finishCallback,failCallback)})}},exports.ComponentFixture=ComponentFixture,exports.resetFakeAsyncZone=resetFakeAsyncZone,exports.fakeAsync=function(fn){return function(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];var proxyZoneSpec=ProxyZoneSpec.assertPresent();if(_inFakeAsyncCall)throw new Error("fakeAsync() calls can not be nested");_inFakeAsyncCall=!0;try{if(!_fakeAsyncTestZoneSpec){if(proxyZoneSpec.getDelegate()instanceof FakeAsyncTestZoneSpec)throw new Error("fakeAsync() calls can not be nested");_fakeAsyncTestZoneSpec=new FakeAsyncTestZoneSpec}var res=void 0,lastProxyZoneSpec=proxyZoneSpec.getDelegate();proxyZoneSpec.setDelegate(_fakeAsyncTestZoneSpec);try{res=fn.apply(this,args),flushMicrotasks()}finally{proxyZoneSpec.setDelegate(lastProxyZoneSpec)}if(_fakeAsyncTestZoneSpec.pendingPeriodicTimers.length>0)throw new Error(_fakeAsyncTestZoneSpec.pendingPeriodicTimers.length+" periodic timer(s) still in the queue.");if(_fakeAsyncTestZoneSpec.pendingTimers.length>0)throw new Error(_fakeAsyncTestZoneSpec.pendingTimers.length+" timer(s) still in the queue.");return res}finally{_inFakeAsyncCall=!1,resetFakeAsyncZone()}}},exports.tick=function(millis){void 0===millis&&(millis=0),_getFakeAsyncZoneSpec().tick(millis)},exports.flush=function(maxTurns){return _getFakeAsyncZoneSpec().flush(maxTurns)},exports.discardPeriodicTasks=function(){var zoneSpec=_getFakeAsyncZoneSpec();zoneSpec.pendingPeriodicTimers,zoneSpec.pendingPeriodicTimers.length=0},exports.flushMicrotasks=flushMicrotasks,exports.TestComponentRenderer=TestComponentRenderer,exports.ComponentFixtureAutoDetect=ComponentFixtureAutoDetect,exports.ComponentFixtureNoNgZone=ComponentFixtureNoNgZone,exports.TestBed=TestBed,exports.getTestBed=getTestBed,exports.inject=inject,exports.InjectSetupWrapper=InjectSetupWrapper,exports.withModule=function(moduleDef,fn){return fn?function(){var testBed=getTestBed();return moduleDef&&testBed.configureTestingModule(moduleDef),fn.apply(this)}:new InjectSetupWrapper(function(){return moduleDef})},exports.__core_private_testing_placeholder__="",exports.ɵTestingCompiler=TestingCompiler,exports.ɵTestingCompilerFactory=TestingCompilerFactory,exports.withBody=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(html,blockFn){return function(done){if(ensureDocument(),"function"==typeof blockFn){document.body.innerHTML=html;var blockReturn=blockFn();blockReturn instanceof Promise?blockReturn=blockReturn.then(done,done.fail):done()}}},exports.ensureDocument=ensureDocument,exports.cleanupDocument=cleanupDocument,exports.ɵ0=ɵ0,Object.defineProperty(exports,"__esModule",{value:!0})});